...
public class DoubleScalarTest
{
    ...
    public final void relOpAbsTest()
    {
        ...
        MutableDoubleScalar.Abs<LengthUnit> same2 = new MutableDoubleScalar.Abs<LengthUnit>(123000, LengthUnit.METER);
        MutableDoubleScalar.Abs<LengthUnit> smaller2 = new MutableDoubleScalar.Abs<LengthUnit>(122999, LengthUnit.METER);
        MutableDoubleScalar.Abs<LengthUnit> larger2 = new MutableDoubleScalar.Abs<LengthUnit>(123001, LengthUnit.METER);
    ...
    {
        MutableDoubleScalar.Abs<LengthUnit> base = new MutableDoubleScalar.Abs<LengthUnit>(123, LengthUnit.KILOMETER);
        MutableDoubleScalar.Abs<LengthUnit> same = new MutableDoubleScalar.Abs<LengthUnit>(123000, LengthUnit.METER);
        MutableDoubleScalar.Abs<LengthUnit> smaller = new MutableDoubleScalar.Abs<LengthUnit>(122999, LengthUnit.METER);
        MutableDoubleScalar.Abs<LengthUnit> larger = new MutableDoubleScalar.Abs<LengthUnit>(123001, LengthUnit.METER);
        assertFalse("123km < 123000m", base.lt(same));
        assertTrue("123km <= 123000m", base.le(same));
        assertTrue("123km >= 123000m", base.ge(same));
        assertFalse("NOT 123km > 123000m", base.gt(same));
    ...
    public final void relOpRelTest()
    {
        ...
        assertFalse("NOT 123km >= 123001m", base.ge(larger));
        assertFalse("NOT 123km <= 122999m", base.le(smaller));
        MutableDoubleScalar.Rel<LengthUnit> same2 = new MutableDoubleScalar.Rel<LengthUnit>(123000, LengthUnit.METER);
        MutableDoubleScalar.Rel<LengthUnit> smaller2 = new MutableDoubleScalar.Rel<LengthUnit>(122999, LengthUnit.METER);
        MutableDoubleScalar.Rel<LengthUnit> larger2 = new MutableDoubleScalar.Rel<LengthUnit>(123001, LengthUnit.METER);
        assertFalse("NOT 123km < 123000m", base.lt(same2));
        assertTrue("123km <= 123000m", base.le(same2));
        assertTrue("123km >= 123000m", base.ge(same2));
        assertFalse("NOT 123km > 123000m", base.gt(same2));
    ...
    {
        MutableDoubleScalar.Rel<LengthUnit> base = new MutableDoubleScalar.Rel<LengthUnit>(123, LengthUnit.KILOMETER);
        MutableDoubleScalar.Rel<LengthUnit> same = new MutableDoubleScalar.Rel<LengthUnit>(123000, LengthUnit.METER);
        MutableDoubleScalar.Rel<LengthUnit> smaller = new MutableDoubleScalar.Rel<LengthUnit>(122999, LengthUnit.METER);
        MutableDoubleScalar.Rel<LengthUnit> larger = new MutableDoubleScalar.Rel<LengthUnit>(123001, LengthUnit.METER);
        assertFalse("123km < 123000m", base.lt(same));
        assertTrue("123km <= 123000m", base.le(same));
        assertTrue("123km >= 123000m", base.ge(same));
        assertFalse("NOT 123km > 123000m", base.gt(same));
