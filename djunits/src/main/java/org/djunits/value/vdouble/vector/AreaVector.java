 ...
 */
public abstract class AreaVector extends DoubleVector.Rel<AreaUnit>
{
    /** */
     ...
     */
    public AreaVector(final AreaUnit unit)
    {
        super(unit);
    }
    ...
    /** {@inheritDoc} */
    public abstract AreaVector toDense();

    /** {@inheritDoc} */
    public abstract AreaVector toSparse();

    /**
     * Double Dense Relative Immutable Area class.
     */
    public static class Dense extends AreaVector implements DenseData
    {
        /** */
         ...
         * @param values List&lt;Area&gt;; the values of the Scalar Area entries in the new Relative Dense Immutable
         *            DoubleVector
        ...
        {
            return new MutableAreaVector.Dense(getData(), getUnit());
        }
        ...
        {
            return new AreaVector.Sparse(getData().toSparse(), getUnit());
        }
    }
     ...
     */
    public static class Sparse extends AreaVector implements SparseData
    {
        /** */
        private static final long serialVersionUID = 20150905L;
        ...
        public final MutableAreaVector mutable()
        {
            return new MutableAreaVector.Sparse(getData(), getUnit());
        }
        ...
        public final AreaVector toDense()
        {
            return new AreaVector.Dense(getData().toDense(), getUnit());
        }
     ...
     * @param unit the unit to use
     * @return an AreaVector
     */
    static AreaVector instantiate(final DoubleVectorData dvData, final AreaUnit unit)
    {
        if (dvData instanceof DoubleVectorDataSparse)
        {
            return new AreaVector.Sparse((DoubleVectorDataSparse) dvData, unit);
        }
        else
        {
            return new AreaVector.Dense((DoubleVectorDataDense) dvData, unit);
        }
    }
