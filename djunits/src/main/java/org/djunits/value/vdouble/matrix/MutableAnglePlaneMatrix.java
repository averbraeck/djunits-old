 ...
 */
public interface MutableAnglePlaneMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedDoubleMatrixAbs<AnglePlaneUnit, AnglePlaneMatrix.Abs, AnglePlaneMatrix.Rel, MutableAnglePlaneMatrix.Abs, AnglePlane.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable Double AnglePlaneMatrix.
         * @param values double[][]; the values of the entries in the new Absolute Mutable Double AnglePlaneMatrix
         * @param unit U; the unit of the new Absolute Mutable Double AnglePlaneMatrix
         ...
         */
        public final MutableAnglePlaneMatrix.Rel toRel()
        {
            return new MutableAnglePlaneMatrix.Rel(getData(), getUnit());
        }
     ...
     */
    class Rel extends
        MutableTypedDoubleMatrixRel<AnglePlaneUnit, AnglePlaneMatrix.Rel, MutableAnglePlaneMatrix.Rel, AnglePlane.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable Double AnglePlaneMatrix.
         * @param values double[][]; the values of the entries in the new Relative Mutable Double AnglePlaneMatrix
         * @param unit U; the unit of the new Relative Mutable Double AnglePlaneMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final MutableAnglePlaneMatrix.Abs toAbs()
        {
            return new MutableAnglePlaneMatrix.Abs(getData(), getUnit());
        }
