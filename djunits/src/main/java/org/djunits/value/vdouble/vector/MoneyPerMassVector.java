 ...
 */
public abstract class MoneyPerMassVector extends DoubleVector.Rel<MoneyPerMassUnit>
{
    /** */
     ...
     */
    public MoneyPerMassVector(final MoneyPerMassUnit unit)
    {
        super(unit);
    }
    ...
    /** {@inheritDoc} */
    public abstract MoneyPerMassVector toDense();

    /** {@inheritDoc} */
    public abstract MoneyPerMassVector toSparse();

    /**
     * Double Dense Relative Immutable MoneyPerMass class.
     */
    public static class Dense extends MoneyPerMassVector implements DenseData
    {
        /** */
        ...
        {
            return new MutableMoneyPerMassVector.Dense(getData(), getUnit());
        }
        ...
        {
            return new MoneyPerMassVector.Sparse(getData().toSparse(), getUnit());
        }
    }
     ...
     */
    public static class Sparse extends MoneyPerMassVector implements SparseData
    {
        /** */
        private static final long serialVersionUID = 20150905L;
        ...
        public final MutableMoneyPerMassVector mutable()
        {
            return new MutableMoneyPerMassVector.Sparse(getData(), getUnit());
        }
        ...
        public final MoneyPerMassVector toDense()
        {
            return new MoneyPerMassVector.Dense(getData().toDense(), getUnit());
        }
     ...
     * @param unit the unit to use
     * @return an MoneyPerMassVector
     */
    static MoneyPerMassVector instantiate(final DoubleVectorData dvData, final MoneyPerMassUnit unit)
    {
        if (dvData instanceof DoubleVectorDataSparse)
        {
            return new MoneyPerMassVector.Sparse((DoubleVectorDataSparse) dvData, unit);
        }
        else
        {
            return new MoneyPerMassVector.Dense((DoubleVectorDataDense) dvData, unit);
        }
    }
