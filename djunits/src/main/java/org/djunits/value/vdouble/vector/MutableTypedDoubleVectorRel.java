    ...
    extends MutableDoubleVector.Rel<U>
{
     ...
     */
    MutableTypedDoubleVectorRel(final double[] values, final U unit, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    MutableTypedDoubleVectorRel(final List<Double> values, final U unit, final DataType dataType) throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    MutableTypedDoubleVectorRel(final S[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    MutableTypedDoubleVectorRel(final List<S> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    MutableTypedDoubleVectorRel(final SortedMap<Integer, S> values, final int length, final DataType dataType)
