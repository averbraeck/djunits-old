...
public interface MutableLengthVector
{
        ...
        MutableTypedDoubleVectorAbs<LengthUnit, LengthVector.Abs, LengthVector.Rel, MutableLengthVector.Abs, Length.Abs>
    {
         ...
         * @throws ValueException when values has zero entries
         */
        public Abs(final List<Length.Abs> values, final StorageType storageType) throws ValueException
        {
            super(values, storageType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Abs(final SortedMap<Integer, Length.Abs> values, final int length, final StorageType storageType)
         ...
         */
        public final MutableLengthVector.Rel toRel()
        {
            return new MutableLengthVector.Rel(getData(), getUnit());
        }
    ...
    class Rel extends MutableTypedDoubleVectorRel<LengthUnit, LengthVector.Rel, MutableLengthVector.Rel, Length.Rel>
    {
         ...
         * @throws ValueException when values has zero entries
         */
        public Rel(final List<Length.Rel> values, final StorageType storageType) throws ValueException
        {
            super(values, storageType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Rel(final SortedMap<Integer, Length.Rel> values, final int length, final StorageType storageType)
            throws ValueException
        {
            super(values, length, storageType);
        }
         ...
         */
        public final MutableLengthVector.Abs toAbs()
        {
            return new MutableLengthVector.Abs(getData(), getUnit());
        }
