    ...
    MutableTypedDoubleVectorRel<FlowVolumeUnit, FlowVolumeVector, MutableFlowVolumeVector, FlowVolume>
{
     ...
     */
    public MutableFlowVolumeVector(final double[] values, final FlowVolumeUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableFlowVolumeVector(final List<Double> values, final FlowVolumeUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableFlowVolumeVector(final FlowVolume[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFlowVolumeVector(final List<FlowVolume> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
