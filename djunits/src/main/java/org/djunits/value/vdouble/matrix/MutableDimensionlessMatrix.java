 ...
 */
public interface MutableDimensionlessMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedDoubleMatrixAbs<DimensionlessUnit, DimensionlessMatrix.Abs, DimensionlessMatrix.Rel, MutableDimensionlessMatrix.Abs, Dimensionless.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable Double DimensionlessMatrix.
         * @param values double[][]; the values of the entries in the new Absolute Mutable Double DimensionlessMatrix
         * @param unit U; the unit of the new Absolute Mutable Double DimensionlessMatrix
         ...
         */
        public final MutableDimensionlessMatrix.Rel toRel()
        {
            return new MutableDimensionlessMatrix.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        MutableTypedDoubleMatrixRel<DimensionlessUnit, DimensionlessMatrix.Rel, MutableDimensionlessMatrix.Rel, Dimensionless.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable Double DimensionlessMatrix.
         * @param values double[][]; the values of the entries in the new Relative Mutable Double DimensionlessMatrix
         * @param unit U; the unit of the new Relative Mutable Double DimensionlessMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final MutableDimensionlessMatrix.Abs toAbs()
        {
            return new MutableDimensionlessMatrix.Abs(getData(), getUnit());
        }
