    ...
    MutableTypedDoubleVectorRel<ElectricalCurrentUnit, ElectricalCurrentVector, MutableElectricalCurrentVector, ElectricalCurrent>
{
     ...
     */
    public MutableElectricalCurrentVector(final ElectricalCurrent[] values, final DataType dataType)
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalCurrentVector(final List<ElectricalCurrent> values, final DataType dataType)
        throws ValueException
    {
        super(values, dataType);
    }
