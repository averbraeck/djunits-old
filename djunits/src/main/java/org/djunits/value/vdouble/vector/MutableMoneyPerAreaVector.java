    ...
    MutableTypedDoubleVectorRel<MoneyPerAreaUnit, MoneyPerAreaVector, MutableMoneyPerAreaVector, MoneyPerArea>
{
     ...
     */
    public MutableMoneyPerAreaVector(final double[] values, final MoneyPerAreaUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableMoneyPerAreaVector(final List<Double> values, final MoneyPerAreaUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableMoneyPerAreaVector(final MoneyPerArea[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMoneyPerAreaVector(final List<MoneyPerArea> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
