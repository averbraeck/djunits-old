    ...
    MutableTypedDoubleVectorRel<ElectricalChargeUnit, ElectricalChargeVector, MutableElectricalChargeVector, ElectricalCharge>
{
     ...
     */
    public MutableElectricalChargeVector(final double[] values, final ElectricalChargeUnit unit, final DataType dataType)
     ...
     */
    public MutableElectricalChargeVector(final ElectricalCharge[] values, final DataType dataType)
        throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalChargeVector(final List<ElectricalCharge> values, final DataType dataType)
        throws ValueException
    {
        super(values, dataType);
    }
