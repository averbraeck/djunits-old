...
public interface AngleSlopeVector
{
    ...
    class Abs
        extends
        TypedDoubleVectorAbs<AngleSlopeUnit, AngleSlopeVector.Abs, AngleSlopeVector.Rel, MutableAngleSlopeVector.Abs, AngleSlope.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable Double AngleSlopeVector.
         * @param values double[]; the values of the entries in the new Absolute Immutable Double AngleSlopeVector
         * @param unit U; the unit of the new Absolute Immutable Double AngleSlopeVector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        public Abs(final double[] values, final AngleSlopeUnit unit, final DataType dataType) throws ValueException
        {
        ...
        /**
         * Construct a new Absolute Immutable Double AngleSlopeVector.
         * @param values List; the values of the entries in the new Absolute Immutable Double AngleSlopeVector
         * @param unit U; the unit of the new Absolute Immutable Double AngleSlopeVector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        public Abs(final List<Double> values, final AngleSlopeUnit unit, final DataType dataType) throws ValueException
        {
            super(values, unit, dataType);
        }
         ...
         */
        public Abs(final AngleSlope.Abs[] values, final DataType dataType) throws ValueException
        {
         ...
         * @throws ValueException when values has zero entries
         */
        public Abs(final List<AngleSlope.Abs> values, final DataType dataType) throws ValueException
        {
            super(values, dataType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Abs(final SortedMap<Integer, AngleSlope.Abs> values, final int length, final DataType dataType)
         ...
         */
        public final AngleSlopeVector.Rel toRel()
        {
            return new AngleSlopeVector.Rel(getData(), getUnit());
        }
     ...
     */
    class Rel extends
        TypedDoubleVectorRel<AngleSlopeUnit, AngleSlopeVector.Rel, MutableAngleSlopeVector.Rel, AngleSlope.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable Double AngleSlopeVector.
         * @param values double[]; the values of the entries in the new Relative Immutable Double AngleSlopeVector
         * @param unit U; the unit of the new Relative Immutable Double AngleSlopeVector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        public Rel(final double[] values, final AngleSlopeUnit unit, final DataType dataType) throws ValueException
        {
            super(values, unit, dataType);
        }
        ...
        /**
         * Construct a new Relative Immutable Double AngleSlopeVector.
         * @param values List; the values of the entries in the new Relative Immutable Double AngleSlopeVector
         * @param unit U; the unit of the new Relative Immutable Double AngleSlopeVector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        public Rel(final List<Double> values, final AngleSlopeUnit unit, final DataType dataType) throws ValueException
        {
            super(values, unit, dataType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Rel(final AngleSlope.Rel[] values, final DataType dataType) throws ValueException
        {
            super(values, dataType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Rel(final List<AngleSlope.Rel> values, final DataType dataType) throws ValueException
        {
            super(values, dataType);
        }
         ...
         * @throws ValueException when values has zero entries
         */
        public Rel(final SortedMap<Integer, AngleSlope.Rel> values, final int length, final DataType dataType)
            throws ValueException
        {
            super(values, length, dataType);
        }
         ...
         */
        public final AngleSlopeVector.Abs toAbs()
        {
            return new AngleSlopeVector.Abs(getData(), getUnit());
        }
