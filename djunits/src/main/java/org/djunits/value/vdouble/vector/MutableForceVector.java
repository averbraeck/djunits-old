...
public class MutableForceVector extends MutableTypedDoubleVectorRel<ForceUnit, ForceVector, MutableForceVector, Force>
{
     ...
     */
    public MutableForceVector(final double[] values, final ForceUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableForceVector(final List<Double> values, final ForceUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableForceVector(final Force[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableForceVector(final List<Force> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableForceVector(final SortedMap<Integer, Force> values, final int length, final DataType dataType)
        throws ValueException
    {
