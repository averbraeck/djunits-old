    ...
    TypedDoubleVectorRel<AngleSolidUnit, AngleSolidVector, MutableAngleSolidVector, AngleSolid>
{
     ...
     */
    public AngleSolidVector(final double[] values, final AngleSolidUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public AngleSolidVector(final List<Double> values, final AngleSolidUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public AngleSolidVector(final AngleSolid[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public AngleSolidVector(final List<AngleSolid> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public AngleSolidVector(final SortedMap<Integer, AngleSolid> values, final int length, final DataType dataType)
        throws ValueException
    {
