    ...
    MutableTypedDoubleVectorRel<PressureUnit, PressureVector, MutablePressureVector, Pressure>
{
     ...
     */
    public MutablePressureVector(final double[] values, final PressureUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutablePressureVector(final List<Double> values, final PressureUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutablePressureVector(final Pressure[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutablePressureVector(final List<Pressure> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutablePressureVector(final SortedMap<Integer, Pressure> values, final int length, final DataType dataType)
        throws ValueException
    {
