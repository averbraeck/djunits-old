...
public class MutableAreaVector extends MutableTypedDoubleVectorRel<AreaUnit, AreaVector, MutableAreaVector, Area>
{
     ...
     */
    public MutableAreaVector(final double[] values, final AreaUnit unit, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableAreaVector(final List<Double> values, final AreaUnit unit, final DataType dataType)
     ...
     */
    public MutableAreaVector(final Area[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAreaVector(final List<Area> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAreaVector(final SortedMap<Integer, Area> values, final int length, final DataType dataType)
        throws ValueException
    {
