...
/**
 * Mutable FloatDimensionless Vector.
 * <p>
 ...
 */
public interface MutableFloatDimensionlessVector
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedFloatVectorAbs<DimensionlessUnit, FloatDimensionlessVector.Abs, FloatDimensionlessVector.Rel, MutableFloatDimensionlessVector.Abs, FloatDimensionless.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable FloatDimensionlessVector.
         * @param values float[]; the values of the entries in the new Absolute Mutable FloatDimensionlessVector
         * @param unit U; the unit of the new Absolute Mutable FloatDimensionlessVector
        ...
        /**
         * Construct a new Absolute Mutable FloatDimensionlessVector.
         * @param values List; the values of the entries in the new Absolute Mutable FloatDimensionlessVector
         * @param unit U; the unit of the new Absolute Mutable FloatDimensionlessVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final MutableFloatDimensionlessVector.Rel toRel()
        {
            return new MutableFloatDimensionlessVector.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        MutableTypedFloatVectorRel<DimensionlessUnit, FloatDimensionlessVector.Rel, MutableFloatDimensionlessVector.Rel, FloatDimensionless.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable FloatDimensionlessVector.
         * @param values float[]; the values of the entries in the new Relative Mutable FloatDimensionlessVector
         * @param unit U; the unit of the new Relative Mutable FloatDimensionlessVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable FloatDimensionlessVector.
         * @param values List; the values of the entries in the new Relative Mutable FloatDimensionlessVector
         * @param unit U; the unit of the new Relative Mutable FloatDimensionlessVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final MutableFloatDimensionlessVector.Abs toAbs()
        {
            return new MutableFloatDimensionlessVector.Abs(getData(), getUnit());
        }
