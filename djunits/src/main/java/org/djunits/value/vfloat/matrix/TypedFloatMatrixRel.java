        ...
        extends FloatMatrix.Rel<U>
{
     ...
     */
    TypedFloatMatrixRel(final float[][] values, final U unit, final StorageType storageType) throws ValueException
    {
     ...
     */
    TypedFloatMatrixRel(final S[][] values, final StorageType storageType) throws ValueException
    {
     ...
     * @param unit the unit
     */
    TypedFloatMatrixRel(final FloatMatrixData data, final U unit)
    {
        super(data, unit);
    }
