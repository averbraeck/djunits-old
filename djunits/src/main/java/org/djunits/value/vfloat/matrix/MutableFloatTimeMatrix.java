 ...
 */
public interface MutableFloatTimeMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedFloatMatrixAbs<TimeUnit, FloatTimeMatrix.Abs, FloatTimeMatrix.Rel, MutableFloatTimeMatrix.Abs, FloatTime.Abs>
    {
        /** */
         ...
         */
        public final MutableFloatTimeMatrix.Rel toRel()
        {
            return new MutableFloatTimeMatrix.Rel(getData(), getUnit());
        }
     ...
     */
    class Rel extends
        MutableTypedFloatMatrixRel<TimeUnit, FloatTimeMatrix.Rel, MutableFloatTimeMatrix.Rel, FloatTime.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable FloatTimeMatrix.
         * @param values float[][]; the values of the entries in the new Relative Mutable FloatTimeMatrix
         * @param unit U; the unit of the new Relative Mutable FloatTimeMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable FloatTimeMatrix.
         * @param values FloatScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Relative Mutable FloatTimeMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values has zero entries
         */
         ...
         */
        public final MutableFloatTimeMatrix.Abs toAbs()
        {
            return new MutableFloatTimeMatrix.Abs(getData(), getUnit());
        }
