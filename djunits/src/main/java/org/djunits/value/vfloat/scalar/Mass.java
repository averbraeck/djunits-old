...
/**
 * Easy access methods for the Mass FloatScalar. Instead of <br>
...
public interface Mass extends UNITS
{
    ...
    public static class Rel extends FloatScalar.Rel<MassUnit>
    {
         ...
         */
        public Rel(final float value, final MassUnit unit)
        {
            super(value, unit);
        }
         ...
         */
        public Rel(final FloatScalar.Rel<MassUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Mass.Rel((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Rel((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final Mass.Rel multiplyBy(final float factor)
        {
    ...
    public static class Abs extends FloatScalar.Abs<MassUnit>
    {
         ...
         * @param unit unit for the float value
         */
        public Abs(final float value, final MassUnit unit)
        {
            super(value, unit);
        }
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final FloatScalar.Abs<MassUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Mass.Abs((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Mass.Abs((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final Mass.Abs multiplyBy(final float factor)
        {
