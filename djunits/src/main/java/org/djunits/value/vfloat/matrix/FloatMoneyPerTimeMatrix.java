        ...
        AbstractFloatMatrixRel<MoneyPerTimeUnit, FloatMoneyPerTimeMatrix, MutableFloatMoneyPerTimeMatrix, FloatMoneyPerTime>
{
     ...
     */
    public FloatMoneyPerTimeMatrix(final float[][] values, final MoneyPerTimeUnit unit, final StorageType storageType)
     ...
     */
    public FloatMoneyPerTimeMatrix(final FloatMoneyPerTime[][] values, final StorageType storageType) throws ValueException
    {
     ...
     * @param unit the unit
     */
    FloatMoneyPerTimeMatrix(final FloatMatrixData data, final MoneyPerTimeUnit unit)
    {
        super(data, unit);
    }
