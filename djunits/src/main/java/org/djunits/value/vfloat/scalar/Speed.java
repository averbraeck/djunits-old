...
/**
 * Easy access methods for the Speed FloatScalar, which is relative by definition. An example is Money. Instead of <br>
 ...
 */
public class Speed extends FloatScalar.Rel<SpeedUnit> implements Relative
{
    /** */
     ...
     */
    public Speed(final float value, final SpeedUnit unit)
    {
        super(value, unit);
    }

    /**
     * Construct Speed scalar using a double value.
     ...
     */
    public Speed(final FloatScalar.Rel<SpeedUnit> value)
    {
        super(value);
    }
     ...
     */
    public static Speed interpolate(final Speed zero, final Speed one, final float ratio)
    {
    ...
    {
        return new Speed((float) Math.acos(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.asin(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.atan(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.cbrt(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.ceil(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.cos(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.cosh(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.exp(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.expm1(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.floor(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.log(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.log10(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.log1p(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.rint(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.sin(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.sinh(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.sqrt(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.tan(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.tanh(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed(1.0f / getInUnit(), getUnit());
    }
    ...
    {
        return new Speed((float) Math.toDegrees(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.toRadians(getInUnit()), getUnit());
    }
    ...
    {
        return new Speed((float) Math.pow(getInUnit(), x), getUnit());
    }

    /** {@inheritDoc} */
    @Override
    public final Speed multiplyBy(final float factor)
    {
    ...
    /** {@inheritDoc} */
    @Override
    public final Speed divideBy(final float divisor)
    {
     ...
     * @return new instance of a relative speed
     */
    public final Speed divideBy(final double factor)
    {
