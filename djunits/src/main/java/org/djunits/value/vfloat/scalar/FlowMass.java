...
/**
 * Easy access methods for the FlowMass FloatScalar. Instead of <br>
...
public interface FlowMass extends UNITS
{
    ...
    public static class Rel extends FloatScalar.Rel<FlowMassUnit>
    {
         ...
         */
        public Rel(final float value, final FlowMassUnit unit)
        {
            super(value, unit);
        }

        /**
         * Construct FlowMass.Rel scalar using a double value.
         * @param value float value
         * @param unit unit for the float value
         */
         ...
         */
        public Rel(final FloatScalar.Rel<FlowMassUnit> value)
        {
            super(value);
        }
        ...
        {
            return new FlowMass.Rel((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Rel((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final FlowMass.Rel multiplyBy(final float factor)
        {
        ...
        /** {@inheritDoc} */
        @Override
        public final FlowMass.Rel divideBy(final float divisor)
        {
         ...
         * @return new instance of a relative flowmass
         */
        public final FlowMass.Rel divideBy(final double factor)
        {
    ...
    public static class Abs extends FloatScalar.Abs<FlowMassUnit>
    {
         ...
         * @param unit unit for the float value
         */
        public Abs(final float value, final FlowMassUnit unit)
        {
            super(value, unit);
        }

        /**
         * Construct FlowMass.Abs scalar using a double value.
         * @param value float value
         * @param unit unit for the float value
         */
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final FloatScalar.Abs<FlowMassUnit> value)
        {
            super(value);
        }
        ...
        {
            return new FlowMass.Abs((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new FlowMass.Abs((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final FlowMass.Abs multiplyBy(final float factor)
        {
         ...
         * Multiply scalar with a double factor.
         * @param factor the factor to multiply with
         * @return new instance of an absolute flowmass
         */
        ...
        /** {@inheritDoc} */
        @Override
        public final FlowMass.Abs divideBy(final float divisor)
        {
         ...
         * @return new instance of an absolute flowmass
         */
        public final FlowMass.Abs divideBy(final double factor)
        {
            return divideBy((float) factor);
        }
