...
public class DoubleVectorDenseTest
{
    ...
    public final void toStringAbsTest()
    {
        try
        {
            ...
            DoubleVector.Abs<TemperatureUnit> dv =
                new DoubleVector.Abs<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
    ...
    public final void toStringMutableAbsTest()
    {
        try
        {
            ...
            MutableDoubleVector.Abs<TemperatureUnit> dv =
                new MutableDoubleVector.Abs<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
            String result = dv.toString(true, true);
            assertTrue("toString result contains \" Abs \"", result.contains(" Abs "));
            assertTrue("toString result contains \"K\"", result.contains("K"));
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            temperatureDV = new DoubleVector.Abs<TemperatureUnit>(value, TemperatureUnit.KELVIN, StorageType.DENSE);
            ...
            temperatureDV = new DoubleVector.Abs<TemperatureUnit>(scalar, StorageType.DENSE);
            checkContentsAndType(temperatureDV, value, 0.001, tempUnit, true);
    ...
    public final void toMutableAndBackAbsTest()
    {
        try
        {
            ...
            MutableDoubleVector.Abs<TemperatureUnit> mdvCopy = mdv.copy();
            checkContentsAndType(mdvCopy, value, 0.001, tempUnit, true);
            MutableDoubleVector.Abs<TemperatureUnit> mmdv = mdv.mutable();
    ...
    public final void mathFunctionsTestAbsTest()
    {
        ...
        for (double seedValue : seedValues)
        {
            ...
            try
            {
                dv = new MutableDoubleVector.Abs<LengthUnit>(input, LengthUnit.METER, StorageType.DENSE);
                dv.ceil();
    ...
    public final void binaryplusOfAbsDenseAndRelDenseTest()
    {
        try
        {
            ...
            DoubleVector.Abs<LengthUnit> left =
                new DoubleVector.Abs<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
    ...
    public final void sizeCheckAbsTest()
    {
        ...
        {
            // null array
            new DoubleVector.Abs<TemperatureUnit>((double[]) null, TemperatureUnit.DEGREE_FAHRENHEIT, StorageType.DENSE);
    ...
    public final void binaryplusOfRelDenseAndRelDenseTest()
    {
        try
        {
            ...
            DoubleVector.Rel<LengthUnit> left =
                new DoubleVector.Rel<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
            DoubleVector.Rel<LengthUnit> right =
                new DoubleVector.Rel<LengthUnit>(rightValue, LengthUnit.MILE, StorageType.DENSE);
