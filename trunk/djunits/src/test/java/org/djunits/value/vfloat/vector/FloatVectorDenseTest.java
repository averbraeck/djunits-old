 ...
 */
public class FloatVectorDenseTest
{
    /**
     * Generate test data.
    ...
    public final void toStringAbsTest()
    {
        try
        {
            ...
            FloatVector.Abs<TemperatureUnit> dv =
                new FloatVector.Abs<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
    ...
    public final void toStringMutableAbsTest()
    {
        try
        {
            ...
            MutableFloatVector.Abs<TemperatureUnit> dv =
                new MutableFloatVector.Abs<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
            String result = dv.toString(true, true);
            assertTrue("toString result contains \" Abs \"", result.contains(" Abs "));
            assertTrue("toString result contains \"K\"", result.contains("K"));
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            temperatureDV = new FloatVector.Abs<TemperatureUnit>(value, TemperatureUnit.KELVIN, StorageType.DENSE);
            ...
            temperatureDV = new FloatVector.Abs<TemperatureUnit>(scalar, StorageType.DENSE);
            checkContentsAndType(temperatureDV, value, 0.001, tempUnit, true);
    ...
    public final void binaryplusOfAbsDenseAndRelDenseTest()
    {
        try
        {
            ...
            FloatVector.Abs<LengthUnit> left =
                new FloatVector.Abs<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
    ...
    public final void binaryplusOfAbsDenseAndRelSparseTest()
    {
        try
        {
            ...
            FloatVector.Abs<LengthUnit> left =
                new FloatVector.Abs<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
            FloatVector.Rel<LengthUnit> right =
                new FloatVector.Rel<LengthUnit>(rightValue, LengthUnit.MILE, StorageType.SPARSE);
            FloatVector.Abs<?> result = left.plus(right);
            for (int i = 0; i < leftValue.length; i++)
            {
                assertEquals("value of element should be SI plus of contributing elements", left.getSI(i)
    ...
    public final void sizeCheckAbsTest()
    {
        ...
        {
            // null array
            new FloatVector.Abs<TemperatureUnit>((float[]) null, TemperatureUnit.DEGREE_FAHRENHEIT, StorageType.DENSE);
    ...
    public final void toStringRelTest()
    {
        try
        {
            ...
            FloatVector.Rel<TemperatureUnit> dv =
                new FloatVector.Rel<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
            String result = dv.toString(true, true);
    ...
    public final void basicsRelTest()
    {
        try
        {
            ...
            temperatureDV = new FloatVector.Rel<TemperatureUnit>(value, TemperatureUnit.KELVIN, StorageType.DENSE);
            ...
            temperatureDV = new FloatVector.Rel<TemperatureUnit>(scalar, StorageType.DENSE);
            checkContentsAndType(temperatureDV, value, 0.001, tempUnit, false);
            assertEquals("All cells != 0; cardinality should equal number of cells", value.length, temperatureDV
                .cardinality());
            float sum = 0;
    ...
    public final void binaryplusOfRelDenseAndRelDenseTest()
    {
        try
        {
            ...
            FloatVector.Rel<LengthUnit> left =
                new FloatVector.Rel<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
            FloatVector.Rel<LengthUnit> right =
                new FloatVector.Rel<LengthUnit>(rightValue, LengthUnit.MILE, StorageType.DENSE);
