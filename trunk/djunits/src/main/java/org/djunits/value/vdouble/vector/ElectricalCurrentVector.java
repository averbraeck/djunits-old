 ...
 */
public abstract class ElectricalCurrentVector extends DoubleVector.Rel<ElectricalCurrentUnit>
{
    /** */
     ...
     */
    public ElectricalCurrentVector(final ElectricalCurrentUnit unit)
    {
        super(unit);
    }
    ...
    /** {@inheritDoc} */
    public abstract ElectricalCurrentVector toDense();

    /** {@inheritDoc} */
    public abstract ElectricalCurrentVector toSparse();

    /**
     * Double Dense Relative Immutable ElectricalCurrent class.
     */
    public static class Dense extends ElectricalCurrentVector implements DenseData
    {
        /** */
        ...
        {
            return new MutableElectricalCurrentVector.Dense(getData(), getUnit());
        }
        ...
        {
            return new ElectricalCurrentVector.Sparse(getData().toSparse(), getUnit());
        }
    }
     ...
     */
    public static class Sparse extends ElectricalCurrentVector implements SparseData
    {
        /** */
        private static final long serialVersionUID = 20150905L;
        ...
        public final MutableElectricalCurrentVector mutable()
        {
            return new MutableElectricalCurrentVector.Sparse(getData(), getUnit());
        }
        ...
        public final ElectricalCurrentVector toDense()
        {
            return new ElectricalCurrentVector.Dense(getData().toDense(), getUnit());
        }
     ...
     * @param unit the unit to use
     * @return an ElectricalCurrentVector
     */
    static ElectricalCurrentVector instantiate(final DoubleVectorData dvData, final ElectricalCurrentUnit unit)
    {
        if (dvData instanceof DoubleVectorDataSparse)
        {
            return new ElectricalCurrentVector.Sparse((DoubleVectorDataSparse) dvData, unit);
        }
        else
        {
            return new ElectricalCurrentVector.Dense((DoubleVectorDataDense) dvData, unit);
        }
    }
