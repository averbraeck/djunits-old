 ...
 */
public abstract class MassVector extends DoubleVector.Rel<MassUnit>
{
    /** */
     ...
     */
    public MassVector(final MassUnit unit)
    {
        super(unit);
    }
    ...
    /** {@inheritDoc} */
    public abstract MassVector toDense();

    /** {@inheritDoc} */
    public abstract MassVector toSparse();

    /**
     * Double Dense Relative Immutable Mass class.
     */
    public static class Dense extends MassVector implements DenseData
    {
        /** */
         ...
         * @param values List&lt;Mass&gt;; the values of the Scalar Mass entries in the new Relative Dense Immutable
         *            DoubleVector
        ...
        {
            return new MutableMassVector.Dense(getData(), getUnit());
        }
        ...
        {
            return new MassVector.Sparse(getData().toSparse(), getUnit());
        }
    }
     ...
     */
    public static class Sparse extends MassVector implements SparseData
    {
        /** */
        private static final long serialVersionUID = 20150905L;
        ...
        public final MutableMassVector mutable()
        {
            return new MutableMassVector.Sparse(getData(), getUnit());
        }
        ...
        public final MassVector toDense()
        {
            return new MassVector.Dense(getData().toDense(), getUnit());
        }
     ...
     * @param unit the unit to use
     * @return an MassVector
     */
    static MassVector instantiate(final DoubleVectorData dvData, final MassUnit unit)
    {
        if (dvData instanceof DoubleVectorDataSparse)
        {
            return new MassVector.Sparse((DoubleVectorDataSparse) dvData, unit);
        }
        else
        {
            return new MassVector.Dense((DoubleVectorDataDense) dvData, unit);
        }
    }
