    ...
    TypedDoubleVectorRel<MoneyPerEnergyUnit, MoneyPerEnergyVector, MutableMoneyPerEnergyVector, MoneyPerEnergy>
{
     ...
     */
    public MoneyPerEnergyVector(final double[] values, final MoneyPerEnergyUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MoneyPerEnergyVector(final List<Double> values, final MoneyPerEnergyUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MoneyPerEnergyVector(final MoneyPerEnergy[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MoneyPerEnergyVector(final List<MoneyPerEnergy> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
