...
/**
 * Immutable FloatDimensionless Matrix.
 * <p>
 ...
 */
public interface FloatDimensionlessMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedFloatMatrixAbs<DimensionlessUnit, FloatDimensionlessMatrix.Abs, FloatDimensionlessMatrix.Rel, MutableFloatDimensionlessMatrix.Abs, FloatDimensionless.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable FloatDimensionlessMatrix.
         * @param values float[][]; the values of the entries in the new Absolute Immutable FloatDimensionlessMatrix
         * @param unit U; the unit of the new Absolute Immutable FloatDimensionlessMatrix
         ...
         */
        public final FloatDimensionlessMatrix.Rel toRel()
        {
            return new FloatDimensionlessMatrix.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        TypedFloatMatrixRel<DimensionlessUnit, FloatDimensionlessMatrix.Rel, MutableFloatDimensionlessMatrix.Rel, FloatDimensionless.Rel>
    {
        /** */
         ...
         */
        public final FloatDimensionlessMatrix.Abs toAbs()
        {
            return new FloatDimensionlessMatrix.Abs(getData(), getUnit());
        }
