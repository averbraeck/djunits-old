    ...
    MutableTypedDoubleVectorRel<AccelerationUnit, AccelerationVector, MutableAccelerationVector, Acceleration>
{
     ...
     */
    public MutableAccelerationVector(final double[] values, final AccelerationUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableAccelerationVector(final List<Double> values, final AccelerationUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableAccelerationVector(final Acceleration[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAccelerationVector(final List<Acceleration> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
