...
/**
 * Easy access methods for the Volume FloatScalar. Instead of <br>
...
public interface Volume extends UNITS
{
    ...
    public static class Rel extends FloatScalar.Rel<VolumeUnit>
    {
         ...
         */
        public Rel(final float value, final VolumeUnit unit)
        {
            super(value, unit);
        }
         ...
         */
        public Rel(final FloatScalar.Rel<VolumeUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Volume.Rel((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Rel((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final Volume.Rel multiplyBy(final float factor)
        {
    ...
    public static class Abs extends FloatScalar.Abs<VolumeUnit>
    {
         ...
         * @param unit unit for the float value
         */
        public Abs(final float value, final VolumeUnit unit)
        {
            super(value, unit);
        }
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final FloatScalar.Abs<VolumeUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Volume.Abs((float) Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs(1.0f / getInUnit(), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Volume.Abs((float) Math.pow(getInUnit(), x), getUnit());
        }

        /** {@inheritDoc} */
        @Override
        public final Volume.Abs multiplyBy(final float factor)
        {
