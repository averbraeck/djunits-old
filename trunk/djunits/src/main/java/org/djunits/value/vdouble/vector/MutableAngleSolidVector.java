    ...
    MutableTypedDoubleVectorRel<AngleSolidUnit, AngleSolidVector, MutableAngleSolidVector, AngleSolid>
{
     ...
     */
    public MutableAngleSolidVector(final double[] values, final AngleSolidUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableAngleSolidVector(final List<Double> values, final AngleSolidUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableAngleSolidVector(final AngleSolid[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAngleSolidVector(final List<AngleSolid> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
