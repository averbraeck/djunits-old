    ...
    MutableTypedDoubleVectorRel<MoneyPerTimeUnit, MoneyPerTimeVector, MutableMoneyPerTimeVector, MoneyPerTime>
{
     ...
     */
    public MutableMoneyPerTimeVector(final double[] values, final MoneyPerTimeUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableMoneyPerTimeVector(final List<Double> values, final MoneyPerTimeUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableMoneyPerTimeVector(final MoneyPerTime[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMoneyPerTimeVector(final List<MoneyPerTime> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMoneyPerTimeVector(final SortedMap<Integer, MoneyPerTime> values, final int length,
     ...
     * @throws ValueException when values is null
     */
    public MutableMoneyPerTimeVector(final SortedMap<Integer, Double> values, final MoneyPerTimeUnit unit,
     ...
     * @param unit the unit
     */
    MutableMoneyPerTimeVector(final DoubleVectorData data, final MoneyPerTimeUnit unit)
    {
        super(data, unit);
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableMoneyPerTimeVector instantiateMutableType(final DoubleVectorData dvd,
