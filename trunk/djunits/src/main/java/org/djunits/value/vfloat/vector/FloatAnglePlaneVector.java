 ...
 */
public interface FloatAnglePlaneVector
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedFloatVectorAbs<AnglePlaneUnit, FloatAnglePlaneVector.Abs, FloatAnglePlaneVector.Rel, MutableFloatAnglePlaneVector.Abs, FloatAnglePlane.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable FloatAnglePlaneVector.
         * @param values float[]; the values of the entries in the new Absolute Immutable FloatAnglePlaneVector
         * @param unit U; the unit of the new Absolute Immutable FloatAnglePlaneVector
        ...
        /**
         * Construct a new Absolute Immutable FloatAnglePlaneVector.
         * @param values List; the values of the entries in the new Absolute Immutable FloatAnglePlaneVector
         * @param unit U; the unit of the new Absolute Immutable FloatAnglePlaneVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAnglePlaneVector.Rel toRel()
        {
            return new FloatAnglePlaneVector.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        TypedFloatVectorRel<AnglePlaneUnit, FloatAnglePlaneVector.Rel, MutableFloatAnglePlaneVector.Rel, FloatAnglePlane.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable FloatAnglePlaneVector.
         * @param values float[]; the values of the entries in the new Relative Immutable FloatAnglePlaneVector
         * @param unit U; the unit of the new Relative Immutable FloatAnglePlaneVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Immutable FloatAnglePlaneVector.
         * @param values List; the values of the entries in the new Relative Immutable FloatAnglePlaneVector
         * @param unit U; the unit of the new Relative Immutable FloatAnglePlaneVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAnglePlaneVector.Abs toAbs()
        {
            return new FloatAnglePlaneVector.Abs(getData(), getUnit());
        }
