    ...
    TypedDoubleVectorRel<MoneyPerMassUnit, MoneyPerMassVector, MutableMoneyPerMassVector, MoneyPerMass>
{
     ...
     */
    public MoneyPerMassVector(final double[] values, final MoneyPerMassUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MoneyPerMassVector(final List<Double> values, final MoneyPerMassUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MoneyPerMassVector(final MoneyPerMass[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MoneyPerMassVector(final List<MoneyPerMass> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MoneyPerMassVector(final SortedMap<Integer, MoneyPerMass> values, final int length, final DataType dataType)
        throws ValueException
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableMoneyPerMassVector instantiateMutableType(final DoubleVectorData dvd,
