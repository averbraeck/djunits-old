...
public interface AngleSlope
{
    ...
    public static class Rel extends FloatScalar.Rel<AngleSlopeUnit>
    {
        ...
        public static AngleSlope.Rel
            interpolate(final AngleSlope.Rel zero, final AngleSlope.Rel one, final float ratio)
        {
    ...
    public static class Abs extends FloatScalar.Abs<AngleSlopeUnit>
    {
        ...
        public static AngleSlope.Abs
            interpolate(final AngleSlope.Abs zero, final AngleSlope.Abs one, final float ratio)
        {
