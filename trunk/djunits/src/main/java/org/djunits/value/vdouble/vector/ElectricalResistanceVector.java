    ...
    TypedDoubleVectorRel<ElectricalResistanceUnit, ElectricalResistanceVector, MutableElectricalResistanceVector, ElectricalResistance>
{
     ...
     */
    public ElectricalResistanceVector(final ElectricalResistance[] values, final DataType dataType)
     ...
     * @throws ValueException when values has zero entries
     */
    public ElectricalResistanceVector(final List<ElectricalResistance> values, final DataType dataType)
        throws ValueException
    {
        super(values, dataType);
    }
