...
/**
 * Easy access methods for the ElectricalCurrent DoubleScalar. Instead of <br>
...
public interface ElectricalCurrent extends UNITS
{
    ...
    public static class Rel extends DoubleScalar.Rel<ElectricalCurrentUnit>
    {
         ...
         */
        public Rel(final DoubleScalar.Rel<ElectricalCurrentUnit> value)
        {
            super(value);
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Rel(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final ElectricalCurrent.Rel divideBy(final double divisor)
        {
    ...
    public static class Abs extends DoubleScalar.Abs<ElectricalCurrentUnit>
    {
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final DoubleScalar.Abs<ElectricalCurrentUnit> value)
        {
            super(value);
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new ElectricalCurrent.Abs(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final ElectricalCurrent.Abs divideBy(final double divisor)
        {
