...
/**
 * Easy access methods for the Speed DoubleScalar. Instead of <br>
...
public interface Speed extends UNITS
{
    ...
    public static class Rel extends DoubleScalar.Rel<SpeedUnit>
    {
         ...
         */
        public Rel(final DoubleScalar.Rel<SpeedUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Speed.Rel(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Rel(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final Speed.Rel divideBy(final double divisor)
        {
    ...
    public static class Abs extends DoubleScalar.Abs<SpeedUnit>
    {
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final DoubleScalar.Abs<SpeedUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Speed.Abs(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Speed.Abs(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final Speed.Abs divideBy(final double divisor)
        {
