    ...
    TypedDoubleVectorRel<ElectricalChargeUnit, ElectricalChargeVector, MutableElectricalChargeVector, ElectricalCharge>
{
     ...
     */
    public ElectricalChargeVector(final double[] values, final ElectricalChargeUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public ElectricalChargeVector(final List<Double> values, final ElectricalChargeUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public ElectricalChargeVector(final ElectricalCharge[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public ElectricalChargeVector(final List<ElectricalCharge> values, final DataType dataType) throws ValueException
    {
        super(values, dataType);
    }
