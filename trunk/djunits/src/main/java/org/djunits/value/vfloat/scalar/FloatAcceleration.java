 ...
 * <i>FloatScalar.Rel&lt;AccelerationUnit&gt; value = new FloatScalar.Rel&lt;AccelerationUnit&gt;(100.0, AccelerationUnit.SI);</i><br>
 * we can now write <br>
...
public class FloatAcceleration extends FloatScalar.Rel<AccelerationUnit> implements Relative
{
     ...
     * @return a Scalar at the ratio between
     */
    public static FloatAcceleration interpolate(final FloatAcceleration zero, final FloatAcceleration one, final double ratio)
    {
    ...
    {
        return getUnit().equals(v.getUnit()) ? new FloatAcceleration(getInUnit() + v.getInUnit(), getUnit()) : new FloatAcceleration(this.si
            + v.si, AccelerationUnit.SI);
    }
