    ...
    MutableTypedDoubleVectorRel<MoneyPerLengthUnit, MoneyPerLengthVector, MutableMoneyPerLengthVector, MoneyPerLength>
{
     ...
     */
    public MutableMoneyPerLengthVector(final double[] values, final MoneyPerLengthUnit unit, final DataType dataType)
     ...
     * @throws ValueException when values is null
     */
    public MutableMoneyPerLengthVector(final List<Double> values, final MoneyPerLengthUnit unit, final DataType dataType)
        throws ValueException
    {
        super(values, unit, dataType);
    }
     ...
     */
    public MutableMoneyPerLengthVector(final MoneyPerLength[] values, final DataType dataType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMoneyPerLengthVector(final List<MoneyPerLength> values, final DataType dataType)
        throws ValueException
    {
        super(values, dataType);
    }
