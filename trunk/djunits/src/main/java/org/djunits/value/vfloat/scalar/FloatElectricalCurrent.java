...
public class FloatElectricalCurrent extends AbstractFloatScalarRel<ElectricalCurrentUnit, FloatElectricalCurrent> 
{
    ...
    public static final FloatElectricalCurrent POSITIVE_INFINITY = new FloatElectricalCurrent(Float.POSITIVE_INFINITY, ElectricalCurrentUnit.SI);

    /** Constant with value NEGATIVE_INFINITY. */
    public static final FloatElectricalCurrent NEGATIVE_INFINITY = new FloatElectricalCurrent(Float.NEGATIVE_INFINITY, ElectricalCurrentUnit.SI);

    /** Constant with value MAX_VALUE. */
    public static final FloatElectricalCurrent POS_MAXVALUE = new FloatElectricalCurrent(Float.MAX_VALUE, ElectricalCurrentUnit.SI);

    /** Constant with value -MAX_VALUE. */
    public static final FloatElectricalCurrent NEG_MAXVALUE = new FloatElectricalCurrent(-Float.MAX_VALUE, ElectricalCurrentUnit.SI);
    ...
    {
        return new FloatElectricalCurrent(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getDisplayUnit()) * ratio, zero
            .getDisplayUnit());
    }
     ...
     * @return the maximum value of more than two relative scalars
     */
    public static FloatElectricalCurrent max(final FloatElectricalCurrent r1, final FloatElectricalCurrent r2, final FloatElectricalCurrent... rn)
    {
     ...
     * @return the minimum value of more than two relative scalars
     */
    public static FloatElectricalCurrent min(final FloatElectricalCurrent r1, final FloatElectricalCurrent r2, final FloatElectricalCurrent... rn)
    {
    ...
    /**
     * Returns a FloatElectricalCurrent representation of a textual representation of a value with a unit. The String representation that can be
    ...
    public static FloatElectricalCurrent valueOf(final String text)
    {
        ...
        Throw.when(text.length() == 0, IllegalArgumentException.class, "Error parsing FloatElectricalCurrent: empty text to parse");
    ...
    public static FloatElectricalCurrent of(final float value, final String unitString)
    {
        ...
        Throw.when(unitString.length() == 0, IllegalArgumentException.class, "Error parsing FloatElectricalCurrent: empty unitString");
        ElectricalCurrentUnit unit = ElectricalCurrentUnit.BASE.getUnitByAbbreviation(unitString);
        if (unit != null)
        {
            return new FloatElectricalCurrent(value, unit);
