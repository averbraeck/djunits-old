...
public class FlowVolumeUnit extends LinearUnit<FlowVolumeUnit>
{
     ...
     * @param unitSystem the unit system, e.g. SI or Imperial
     */
    public FlowVolumeUnit(final LengthUnit lengthUnit, final TimeUnit timeUnit, final String name, final String abbreviation,
     ...
     * @param unitSystem the unit system, e.g. SI or Imperial
     */
    public FlowVolumeUnit(final VolumeUnit volumeUnit, final TimeUnit timeUnit, final String name, final String abbreviation,
            final UnitSystem unitSystem)
    {
    ...
    private FlowVolumeUnit(final String nameOrNameKey, final String abbreviationOrAbbreviationKey, final UnitSystem unitSystem,
            final FlowVolumeUnit referenceUnit, final double conversionFactorToReferenceUnit, final boolean standardUnit)
    {
