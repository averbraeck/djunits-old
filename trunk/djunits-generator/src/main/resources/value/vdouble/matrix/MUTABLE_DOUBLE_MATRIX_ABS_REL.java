 ...
 */
public interface Mutable%Type%Matrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedDoubleMatrixAbs<%Type%Unit, %Type%Matrix.Abs, %Type%Matrix.Rel, Mutable%Type%Matrix.Abs, %Type%.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable Double %Type%Matrix.
         * @param values double[][]; the values of the entries in the new Absolute Mutable Double %Type%Matrix
         * @param unit U; the unit of the new Absolute Mutable Double %Type%Matrix
        ...
        /**
         * Construct a new Absolute Mutable Double %Type%Matrix.
         * @param values DoubleScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Absolute Mutable Double %Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         ...
         */
        public final Mutable%Type%Matrix.Rel toRel()
        {
            return new Mutable%Type%Matrix.Rel(getData(), getUnit());
        }
...
%FORMULAS%%Type%.Abs%
     ...
     */
    class Rel extends MutableTypedDoubleMatrixRel<%Type%Unit, %Type%Matrix.Rel, Mutable%Type%Matrix.Rel, %Type%.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable Double %Type%Matrix.
         * @param values double[][]; the values of the entries in the new Relative Mutable Double %Type%Matrix
         * @param unit U; the unit of the new Relative Mutable Double %Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable Double %Type%Matrix.
         * @param values DoubleScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Relative Mutable Double %Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values has zero entries
         */
         ...
         */
        public final Mutable%Type%Matrix.Abs toAbs()
        {
            return new Mutable%Type%Matrix.Abs(getData(), getUnit());
        }
