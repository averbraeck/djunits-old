...
public interface %Type%Vector
{
     ...
     */
    class Abs extends
        TypedDoubleVectorAbs<%Type%Unit, %Type%Vector.Abs, %Type%Vector.Rel, Mutable%Type%Vector.Abs, %Type%.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable Double %Type%Vector.
         * @param values double[]; the values of the entries in the new Absolute Immutable Double %Type%Vector
         * @param unit U; the unit of the new Absolute Immutable Double %Type%Vector
        ...
        /**
         * Construct a new Absolute Immutable Double %Type%Vector.
         * @param values List; the values of the entries in the new Absolute Immutable Double %Type%Vector
         * @param unit U; the unit of the new Absolute Immutable Double %Type%Vector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Absolute Immutable Double %Type%Vector.
         * @param values DoubleScalar.Rel&lt;U&gt;[]; the values of the entries in the new Absolute Immutable Double %Type%Vector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         ...
         */
        public final %Type%Vector.Rel toRel()
        {
            return new %Type%Vector.Rel(getData(), getUnit());
        }
...
%FORMULAS%%Type%.Abs%
     ...
     */
    class Rel extends TypedDoubleVectorRel<%Type%Unit, %Type%Vector.Rel, Mutable%Type%Vector.Rel, %Type%.Rel>
    {
        /** */
        ...
        /**
         * Construct a new Relative Immutable Double %Type%Vector.
         * @param values DoubleScalar.Rel&lt;U&gt;[]; the values of the entries in the new Relative Immutable Double %Type%Vector
         * @param dataType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values has zero entries
         */
         ...
         */
        public final %Type%Vector.Abs toAbs()
        {
            return new %Type%Vector.Abs(getData(), getUnit());
        }
