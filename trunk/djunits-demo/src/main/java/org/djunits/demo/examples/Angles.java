...
public class Angles
{
    ...
    public static void main(final String[] args) throws ValueException
    {
        ...
        // Why does this not work: Angle.Rel normA1 = AngleUnit.normalize(a1);
        // System.out.println("3 * \u03c0: " + a1 + " (" + a1.toString(AngleUnit.DEGREE) + ") -> " + AngleUnit.normalize(a1)
        ...
        System.out.println("  -45\u0090: " + a3 + " (" + a3.toString(AngleUnit.RADIAN) + ", " + a3.toString(AngleUnit.PERCENT)
                ...
                + AngleUnit.normalize(a3).toString(AngleUnit.PERCENT) + ")");
        System.out.println("");
        ...
        System.out.println("-100%: " + a4 + " (" + a4.toString(AngleUnit.DEGREE) + ", " + a4.toString(AngleUnit.RADIAN)
                + ") -> " + AngleUnit.normalize(a4) + " (" + AngleUnit.normalize(a4).toString(AngleUnit.DEGREE) + ", "
                + AngleUnit.normalize(a4).toString(AngleUnit.RADIAN) + ")");
        ...
        System.out.println(" 100%: " + a5 + " (" + a5.toString(AngleUnit.DEGREE) + ", " + a5.toString(AngleUnit.RADIAN)
                + ") -> " + AngleUnit.normalize(a5) + " (" + AngleUnit.normalize(a5).toString(AngleUnit.DEGREE) + ", "
                + AngleUnit.normalize(a5).toString(AngleUnit.RADIAN) + ")");
        ...
        System.out.println("1000%: " + a6 + " (" + a6.toString(AngleUnit.DEGREE) + ", " + a6.toString(AngleUnit.RADIAN)
                + ") -> " + AngleUnit.normalize(a6) + " (" + AngleUnit.normalize(a6).toString(AngleUnit.DEGREE) + ", "
                + AngleUnit.normalize(a6).toString(AngleUnit.RADIAN) + ")");
