        ...
        AbstractMutableDoubleMatrixAbs<%TypeAbsUnit%, %TypeRelUnit%, %TypeAbs%Matrix, %TypeRel%Matrix, Mutable%TypeAbs%Matrix, %TypeAbs%>
{
    ...
    /**
     * Construct a new Absolute Mutable Double %TypeAbs%Matrix.
     * @param values %TypeAbs%[][]; the values of the entries in the new Absolute Mutable Double %TypeAbs%Matrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /** {@inheritDoc} */
    @Override
    public final Mutable%TypeAbs%Matrix toDense()
    {
    ...
    /** {@inheritDoc} */
    @Override
    public final Mutable%TypeAbs%Matrix toSparse()
    {
