    ...
    AbstractFloatVectorRel<%Type%Unit, Float%Type%Vector, MutableFloat%Type%Vector, Float%Type%>
{
     ...
     * @param unit %Type%Unit; the unit of the new Relative Immutable Float Float%Type%Vector
    ...
    /**
     * Construct a new Relative Immutable Float Float%Type%Vector.
     * @param values List&lt;Float&gt;; the values of the entries in the new Relative Immutable Float Float%Type%Vector
     * @param unit %Type%Unit; the unit of the new Relative Immutable Float Float%Type%Vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    /**
     * Construct a new Relative Immutable Float Float%Type%Vector.
     * @param values Float%Type%[]; the values of the entries in the new Relative Immutable Float Float%Type%Vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float Float%Type%Vector.
     * @param values List&lt;Float%Type%&gt;; the values of the entries in the new Relative Immutable Float Float%Type%Vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float Float%Type%Vector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float Float%Type%Vector
     * @param unit %Type%Unit; the unit of the new Relative Sparse Mutable Float Float%Type%Vector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
