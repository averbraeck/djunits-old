    ...
    AbstractMutableFloatVectorRel<ElectricalInductanceUnit, FloatElectricalInductanceVector, MutableFloatElectricalInductanceVector, FloatElectricalInductance> 
{
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalInductanceVector.
     * @param values FloatElectricalInductance[]; the values of the entries in the new Relative Immutable Float ElectricalInductanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalInductanceVector.
     * @param values List&lt;FloatElectricalInductance&gt;; the values of the entries in the new Relative Immutable Float ElectricalInductanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalInductanceVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float ElectricalInductanceVector
