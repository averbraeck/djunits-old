...
public class MutableFloatAbsoluteTemperatureMatrix
        extends
        AbstractMutableFloatMatrixAbs<AbsoluteTemperatureUnit, TemperatureUnit, FloatAbsoluteTemperatureMatrix, FloatTemperatureMatrix, MutableFloatAbsoluteTemperatureMatrix, FloatAbsoluteTemperature>
{
    /** */
     ...
     */
    public MutableFloatAbsoluteTemperatureMatrix(final float[][] values, final AbsoluteTemperatureUnit unit, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Absolute Mutable FloatAbsoluteTemperatureMatrix.
     * @param values FloatAbsoluteTemperature[][]; the values of the entries in the new Absolute Mutable FloatAbsoluteTemperatureMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableFloatAbsoluteTemperatureMatrix(final FloatAbsoluteTemperature[][] values, final StorageType storageType) throws ValueException
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final FloatAbsoluteTemperatureMatrix instantiateTypeAbs(final FloatMatrixData fmd, final AbsoluteTemperatureUnit unit)
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatAbsoluteTemperatureMatrix
        instantiateMutableType(final FloatMatrixData fmd, final AbsoluteTemperatureUnit unit)
    {
