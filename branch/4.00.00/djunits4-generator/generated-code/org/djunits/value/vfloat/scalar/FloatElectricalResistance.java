 ...
 * <pre>FloatScalar.Rel&lt;ElectricalResistanceUnit&gt; value = new FloatScalar.Rel&lt;ElectricalResistanceUnit&gt;(100.0, ElectricalResistanceUnit.SI);</pre>
 * we can now write:
 * <pre>FloatElectricalResistance value = new FloatElectricalResistance(100.0, ElectricalResistanceUnit.SI);</pre>
...
public class FloatElectricalResistance extends AbstractFloatScalarRel<ElectricalResistanceUnit, FloatElectricalResistance> 
{
    ...
    {
        return new FloatElectricalResistance(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
