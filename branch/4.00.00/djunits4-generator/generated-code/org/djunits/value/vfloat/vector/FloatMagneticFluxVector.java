    ...
    AbstractFloatVectorRel<MagneticFluxUnit, FloatMagneticFluxVector, MutableFloatMagneticFluxVector, FloatMagneticFlux>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatMagneticFluxVector.
     * @param values List&lt;FloatMagneticFlux&gt;; the values of the entries in the new Relative Immutable Float FloatMagneticFluxVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatMagneticFluxVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatMagneticFluxVector
