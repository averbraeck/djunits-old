    ...
    AbstractMutableFloatVectorRel<AngleSolidUnit, FloatAngleSolidVector, MutableFloatAngleSolidVector, FloatAngleSolid> 
{
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatAngleSolidVector(final SortedMap<Integer, FloatAngleSolid> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float AngleSolidVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float AngleSolidVector
    ...
    {
        return this.data.isDense() ? (MutableFloatAngleSolidVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatAngleSolidVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
