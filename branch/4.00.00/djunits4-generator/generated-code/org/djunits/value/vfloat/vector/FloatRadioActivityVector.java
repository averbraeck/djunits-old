    ...
    AbstractFloatVectorRel<RadioActivityUnit, FloatRadioActivityVector, MutableFloatRadioActivityVector, FloatRadioActivity>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatRadioActivityVector.
     * @param values FloatRadioActivity[]; the values of the entries in the new Relative Immutable Float FloatRadioActivityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float FloatRadioActivityVector.
     * @param values List&lt;FloatRadioActivity&gt;; the values of the entries in the new Relative Immutable Float FloatRadioActivityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatRadioActivityVector.
     * @param values SortedMap&lt;Integer, FloatRadioActivity&gt;; the values of the entries in the new Relative Sparse Mutable Float
     *            FloatRadioActivityVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatRadioActivityVector(final SortedMap<Integer, FloatRadioActivity> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatRadioActivityVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatRadioActivityVector
