 ...
 */
public class FloatVolumeVector extends
    AbstractFloatVectorRel<VolumeUnit, FloatVolumeVector, MutableFloatVolumeVector, FloatVolume>
{
    /** */
     ...
     */
    public FloatVolumeVector(final float[] values, final VolumeUnit unit, final StorageType storageType)
    ...
    /**
     * Construct a new Relative Immutable Float FloatVolumeVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatVolumeVector
