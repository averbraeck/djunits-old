 ...
 * <pre>FloatScalar.Rel&lt;ElectricalPotentialUnit&gt; value = new FloatScalar.Rel&lt;ElectricalPotentialUnit&gt;(100.0, ElectricalPotentialUnit.SI);</pre>
 * we can now write:
 * <pre>FloatElectricalPotential value = new FloatElectricalPotential(100.0, ElectricalPotentialUnit.SI);</pre>
...
public class FloatElectricalPotential extends AbstractFloatScalarRel<ElectricalPotentialUnit, FloatElectricalPotential> 
{
    ...
    {
        return new FloatElectricalPotential(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
