...
public class FloatDurationVector extends AbstractFloatVectorRel<DurationUnit, FloatDurationVector, MutableFloatDurationVector, FloatDuration>
{
    /** */
     ...
     */
    public FloatDurationVector(final float[] values, final DurationUnit unit, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public FloatDurationVector(final List<Float> values, final DurationUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatDurationVector
        instantiateMutableType(final FloatVectorData dvd, final DurationUnit unit)
    {
