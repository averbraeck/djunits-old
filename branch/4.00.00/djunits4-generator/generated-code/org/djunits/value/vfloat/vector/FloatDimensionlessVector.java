    ...
    AbstractFloatVectorRel<DimensionlessUnit, FloatDimensionlessVector, MutableFloatDimensionlessVector, FloatDimensionless>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatDimensionlessVector.
     * @param values FloatDimensionless[]; the values of the entries in the new Relative Immutable Float FloatDimensionlessVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float FloatDimensionlessVector.
     * @param values List&lt;FloatDimensionless&gt;; the values of the entries in the new Relative Immutable Float FloatDimensionlessVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public FloatDimensionlessVector(final SortedMap<Integer, FloatDimensionless> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatDimensionlessVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatDimensionlessVector
