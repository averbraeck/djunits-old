    ...
    AbstractFloatVectorRel<EquivalentDoseUnit, FloatEquivalentDoseVector, MutableFloatEquivalentDoseVector, FloatEquivalentDose>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatEquivalentDoseVector.
     * @param values FloatEquivalentDose[]; the values of the entries in the new Relative Immutable Float FloatEquivalentDoseVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float FloatEquivalentDoseVector.
     * @param values List&lt;FloatEquivalentDose&gt;; the values of the entries in the new Relative Immutable Float FloatEquivalentDoseVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatEquivalentDoseVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatEquivalentDoseVector
