    ...
    AbstractMutableFloatVectorRel<ElectricalCapacitanceUnit, FloatElectricalCapacitanceVector, MutableFloatElectricalCapacitanceVector, FloatElectricalCapacitance> 
{
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCapacitanceVector.
     * @param values List&lt;Float&gt;; the values of the entries in the new Relative Immutable Float ElectricalCapacitanceVector
     * @param unit ElectricalCapacitanceUnit; the unit of the new Relative Immutable Float ElectricalCapacitanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCapacitanceVector.
     * @param values FloatElectricalCapacitance[]; the values of the entries in the new Relative Immutable Float ElectricalCapacitanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCapacitanceVector.
     * @param values List&lt;FloatElectricalCapacitance&gt;; the values of the entries in the new Relative Immutable Float ElectricalCapacitanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCapacitanceVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float ElectricalCapacitanceVector
