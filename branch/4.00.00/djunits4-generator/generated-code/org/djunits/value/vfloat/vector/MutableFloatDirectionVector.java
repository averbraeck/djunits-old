...
public class MutableFloatDirectionVector
    extends
    AbstractMutableFloatVectorAbs<DirectionUnit, AngleUnit, FloatDirectionVector, FloatAngleVector, MutableFloatDirectionVector, FloatDirection>
{
    /** */
     ...
     */
    public MutableFloatDirectionVector(final float[] values, final DirectionUnit unit, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableFloatDirectionVector(final List<Float> values, final DirectionUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatDirectionVector(final SortedMap<Integer, FloatDirection> values, final int length, final StorageType storageType)
    ...
    {
        return this.data.isDense() ? (MutableFloatDirectionVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatDirectionVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
