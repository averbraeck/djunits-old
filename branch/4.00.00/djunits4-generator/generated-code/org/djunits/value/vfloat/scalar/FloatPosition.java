...
public class FloatPosition extends AbstractFloatScalarAbs<PositionUnit, FloatPosition, LengthUnit, FloatLength>
{
    ...
    {
        return new FloatPosition(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
    ...
    {
        Throw.whenNull(text, "Error parsing FloatPosition: unitString is null");
        Throw.when(text.length() == 0, IllegalArgumentException.class, "Error parsing FloatPosition: empty unitString");
