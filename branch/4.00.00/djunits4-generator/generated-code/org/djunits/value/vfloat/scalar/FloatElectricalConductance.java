...
/**
 * Easy access methods for the ElectricalConductance FloatScalar, which is relative by definition. An example is Speed. Instead of:
 * <pre>FloatScalar.Rel&lt;ElectricalConductanceUnit&gt; value = new FloatScalar.Rel&lt;ElectricalConductanceUnit&gt;(100.0, ElectricalConductanceUnit.SI);</pre>
 * we can now write:
 * <pre>FloatElectricalConductance value = new FloatElectricalConductance(100.0, ElectricalConductanceUnit.SI);</pre>
