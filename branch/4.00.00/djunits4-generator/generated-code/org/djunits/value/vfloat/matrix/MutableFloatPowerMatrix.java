...
public class MutableFloatPowerMatrix extends
    AbstractMutableFloatMatrixRel<PowerUnit, FloatPowerMatrix, MutableFloatPowerMatrix, FloatPower> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable FloatPowerMatrix.
     * @param values FloatPower[][]; the values of the entries in the new Relative Immutable Float
     *            FloatPowerMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
