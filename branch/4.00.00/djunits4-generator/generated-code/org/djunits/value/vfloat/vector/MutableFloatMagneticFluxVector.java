 ...
 */
public class MutableFloatMagneticFluxVector extends
    AbstractMutableFloatVectorRel<MagneticFluxUnit, FloatMagneticFluxVector, MutableFloatMagneticFluxVector, FloatMagneticFlux> 
{
    /** */
     ...
     * @param unit U; the unit of the new Relative Immutable Float MagneticFluxVector
    ...
    /**
     * Construct a new Relative Immutable Float MagneticFluxVector.
     * @param values List; the values of the entries in the new Relative Immutable Float MagneticFluxVector
     * @param unit U; the unit of the new Relative Immutable Float MagneticFluxVector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatMagneticFluxVector(final List<FloatMagneticFlux> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatMagneticFluxVector(final SortedMap<Integer, FloatMagneticFlux> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float MagneticFluxVector.
     * @param values Map; the map of indexes to values of the Relative Sparse Mutable Float MagneticFluxVector
     * @param unit U; the unit of the new Relative Sparse Mutable Float MagneticFluxVector
     * @param length the size of the vector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    {
        return this.data.isDense() ? (MutableFloatMagneticFluxVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatMagneticFluxVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
