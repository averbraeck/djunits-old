...
public class MutableFloatElectricalCurrentMatrix extends
    AbstractMutableFloatMatrixRel<ElectricalCurrentUnit, FloatElectricalCurrentMatrix, MutableFloatElectricalCurrentMatrix, FloatElectricalCurrent> 
{
    /** */
     ...
     */
    public MutableFloatElectricalCurrentMatrix(final float[][] values, final ElectricalCurrentUnit unit, final StorageType storageType)
     ...
     */
    public MutableFloatElectricalCurrentMatrix(final FloatElectricalCurrent[][] values, final StorageType storageType) throws ValueException
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatElectricalCurrentMatrix instantiateMutableType(final FloatMatrixData fmd, final ElectricalCurrentUnit unit)
    {
