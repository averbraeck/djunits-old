 ...
 * <pre>FloatScalar.Rel&lt;AngleSolidUnit&gt; value = new FloatScalar.Rel&lt;AngleSolidUnit&gt;(100.0, AngleSolidUnit.SI);</pre>
 * we can now write:
 * <pre>FloatAngleSolid value = new FloatAngleSolid(100.0, AngleSolidUnit.SI);</pre>
...
public class FloatAngleSolid extends AbstractFloatScalarRel<AngleSolidUnit, FloatAngleSolid> 
{
    ...
    /**
     * Returns a FloatAngleSolid representation of a textual representation of a value with a unit. The String representation that can be
