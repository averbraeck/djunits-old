...
public class MutableFloatVolumeMatrix extends
    AbstractMutableFloatMatrixRel<VolumeUnit, FloatVolumeMatrix, MutableFloatVolumeMatrix, FloatVolume> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable FloatVolumeMatrix.
     * @param values FloatVolume[][]; the values of the entries in the new Relative Immutable Float
     *            FloatVolumeMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
