    ...
    AbstractFloatVectorRel<LinearDensityUnit, FloatLinearDensityVector, MutableFloatLinearDensityVector, FloatLinearDensity>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatLinearDensityVector.
     * @param values FloatLinearDensity[]; the values of the entries in the new Relative Immutable Float FloatLinearDensityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float FloatLinearDensityVector.
     * @param values List&lt;FloatLinearDensity&gt;; the values of the entries in the new Relative Immutable Float FloatLinearDensityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public FloatLinearDensityVector(final SortedMap<Integer, FloatLinearDensity> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatLinearDensityVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatLinearDensityVector
