...
public class MutableFloatAngleVector extends AbstractMutableFloatVectorRel<AngleUnit, FloatAngleVector, MutableFloatAngleVector, FloatAngle>
{
     ...
     */
    public MutableFloatAngleVector(final float[] values, final AngleUnit unit, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableFloatAngleVector(final List<Float> values, final AngleUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
    ...
    /**
     * Construct a new Relative Mutable FloatAngleVector.
     * @param values SortedMap&lt;Integer, FloatAngle&gt;; the values of the entries in the new Relative Sparse Mutable FloatAngleVector
    ...
    /**
     * Construct a new Relative Mutable FloatAngleVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable FloatAngleVector
