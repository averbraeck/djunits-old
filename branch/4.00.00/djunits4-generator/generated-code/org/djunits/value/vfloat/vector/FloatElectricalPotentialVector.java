    ...
    AbstractFloatVectorRel<ElectricalPotentialUnit, FloatElectricalPotentialVector, MutableFloatElectricalPotentialVector, FloatElectricalPotential>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalPotentialVector.
     * @param values List&lt;Float&gt;; the values of the entries in the new Relative Immutable Float FloatElectricalPotentialVector
     * @param unit ElectricalPotentialUnit; the unit of the new Relative Immutable Float FloatElectricalPotentialVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalPotentialVector.
     * @param values FloatElectricalPotential[]; the values of the entries in the new Relative Immutable Float FloatElectricalPotentialVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalPotentialVector.
     * @param values List&lt;FloatElectricalPotential&gt;; the values of the entries in the new Relative Immutable Float FloatElectricalPotentialVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalPotentialVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatElectricalPotentialVector
