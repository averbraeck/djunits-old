    ...
    AbstractMutableFloatVectorRel<CatalyticActivityUnit, FloatCatalyticActivityVector, MutableFloatCatalyticActivityVector, FloatCatalyticActivity> 
{
    ...
    /**
     * Construct a new Relative Immutable Float CatalyticActivityVector.
     * @param values FloatCatalyticActivity[]; the values of the entries in the new Relative Immutable Float CatalyticActivityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float CatalyticActivityVector.
     * @param values List&lt;FloatCatalyticActivity&gt;; the values of the entries in the new Relative Immutable Float CatalyticActivityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float CatalyticActivityVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float CatalyticActivityVector
