...
public class MutableFloatFlowMassMatrix extends
    AbstractMutableFloatMatrixRel<FlowMassUnit, FloatFlowMassMatrix, MutableFloatFlowMassMatrix, FloatFlowMass> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable FloatFlowMassMatrix.
     * @param values FloatFlowMass[][]; the values of the entries in the new Relative Immutable Float
     *            FloatFlowMassMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
