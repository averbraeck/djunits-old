...
public class FloatFlowMassVector extends
    AbstractFloatVectorRel<FlowMassUnit, FloatFlowMassVector, MutableFloatFlowMassVector, FloatFlowMass>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Float FloatFlowMassVector.
     * @param values List&lt;FloatFlowMass&gt;; the values of the entries in the new Relative Immutable Float FloatFlowMassVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatFlowMassVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatFlowMassVector
