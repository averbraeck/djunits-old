...
public class MutableFloatDimensionlessVector extends
    AbstractMutableFloatVectorRel<DimensionlessUnit, FloatDimensionlessVector, MutableFloatDimensionlessVector, FloatDimensionless>  implements MathFunctionsDimensionless<MutableFloatDimensionlessVector>
{
    /** */
     ...
     */
    public MutableFloatDimensionlessVector(final FloatDimensionless[] values, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float DimensionlessVector.
     * @param values List&lt;FloatDimensionless&gt;; the values of the entries in the new Relative Immutable Float DimensionlessVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableFloatDimensionlessVector(final List<FloatDimensionless> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Float DimensionlessVector.
     * @param values SortedMap&lt;Integer, FloatDimensionless&gt;; the values of the entries in the new Relative Sparse Mutable Float
     *            DimensionlessVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableFloatDimensionlessVector(final SortedMap<Integer, FloatDimensionless> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float DimensionlessVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float DimensionlessVector
     * @param unit DimensionlessUnit; the unit of the new Relative Sparse Mutable Float DimensionlessVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    public MutableFloatDimensionlessVector(final SortedMap<Integer, Float> values, final DimensionlessUnit unit, final int length,
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatDimensionlessVector instantiateMutableType(final FloatVectorData dvd, final DimensionlessUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableFloatDimensionlessVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatDimensionlessVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
