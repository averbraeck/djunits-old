 ...
 * <pre>FloatScalar.Rel&lt;SpeedUnit&gt; value = new FloatScalar.Rel&lt;SpeedUnit&gt;(100.0, SpeedUnit.SI);</pre>
 * we can now write:
 * <pre>FloatSpeed value = new FloatSpeed(100.0, SpeedUnit.SI);</pre>
...
public class FloatSpeed extends AbstractFloatScalarRel<SpeedUnit, FloatSpeed> 
{
    ...
    {
        return new FloatSpeed(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
    ...
    /**
     * Returns a FloatSpeed representation of a textual representation of a value with a unit. The String representation that can be
