 ...
 * <pre>FloatScalar.Rel&lt;TorqueUnit&gt; value = new FloatScalar.Rel&lt;TorqueUnit&gt;(100.0, TorqueUnit.SI);</pre>
 * we can now write:
 * <pre>FloatTorque value = new FloatTorque(100.0, TorqueUnit.SI);</pre>
...
public class FloatTorque extends AbstractFloatScalarRel<TorqueUnit, FloatTorque> 
{
    ...
    {
        return new FloatTorque(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
