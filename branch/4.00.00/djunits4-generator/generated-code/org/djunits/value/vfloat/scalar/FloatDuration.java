 ...
 * <pre>FloatScalar.Rel&lt;DurationUnit&gt; value = new FloatScalar.Rel&lt;DurationUnit&gt;(100.0, DurationUnit.SI);</pre>
 * we can now write:
 * <pre>FloatDuration value = new FloatDuration(100.0, DurationUnit.SI);</pre>
...
public class FloatDuration extends AbstractFloatScalarRel<DurationUnit, FloatDuration>
{
    ...
    {
        return new FloatDuration(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
