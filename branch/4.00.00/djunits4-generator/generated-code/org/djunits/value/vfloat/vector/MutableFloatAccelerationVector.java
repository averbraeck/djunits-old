    ...
    AbstractMutableFloatVectorRel<AccelerationUnit, FloatAccelerationVector, MutableFloatAccelerationVector, FloatAcceleration> 
{
    ...
    /**
     * Construct a new Relative Immutable Float AccelerationVector.
     * @param values List&lt;FloatAcceleration&gt;; the values of the entries in the new Relative Immutable Float AccelerationVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float AccelerationVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float AccelerationVector
