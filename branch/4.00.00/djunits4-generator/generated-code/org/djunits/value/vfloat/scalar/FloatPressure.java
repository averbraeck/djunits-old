 ...
 * <pre>FloatScalar.Rel&lt;PressureUnit&gt; value = new FloatScalar.Rel&lt;PressureUnit&gt;(100.0, PressureUnit.SI);</pre>
 * we can now write:
 * <pre>FloatPressure value = new FloatPressure(100.0, PressureUnit.SI);</pre>
...
public class FloatPressure extends AbstractFloatScalarRel<PressureUnit, FloatPressure> 
{
    ...
    {
        return new FloatPressure(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
