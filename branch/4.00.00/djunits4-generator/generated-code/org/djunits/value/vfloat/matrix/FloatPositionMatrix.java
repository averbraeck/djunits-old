...
public class FloatPositionMatrix extends
        AbstractFloatMatrixAbs<PositionUnit, LengthUnit, FloatPositionMatrix, FloatLengthMatrix, MutableFloatPositionMatrix, FloatPosition>
{
    /** */
     ...
     */
    public FloatPositionMatrix(final float[][] values, final PositionUnit unit, final StorageType storageType) throws ValueException
    {
