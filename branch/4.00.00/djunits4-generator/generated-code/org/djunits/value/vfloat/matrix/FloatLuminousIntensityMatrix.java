...
public class FloatLuminousIntensityMatrix extends
    AbstractFloatMatrixRel<LuminousIntensityUnit, FloatLuminousIntensityMatrix, MutableFloatLuminousIntensityMatrix, FloatLuminousIntensity>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable FloatLuminousIntensityMatrix.
     * @param values FloatLuminousIntensity; the values of the entries in the new Relative Immutable FloatLuminousIntensityMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatLuminousIntensityMatrix(final FloatLuminousIntensity[][] values, final StorageType storageType) throws ValueException
    {
