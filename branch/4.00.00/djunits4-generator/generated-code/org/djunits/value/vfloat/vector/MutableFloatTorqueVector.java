...
public class MutableFloatTorqueVector extends
    AbstractMutableFloatVectorRel<TorqueUnit, FloatTorqueVector, MutableFloatTorqueVector, FloatTorque> 
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatTorqueVector(final SortedMap<Integer, FloatTorque> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float TorqueVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float TorqueVector
