    ...
    AbstractFloatMatrixRel<ElectricalCurrentUnit, FloatElectricalCurrentMatrix, MutableFloatElectricalCurrentMatrix, FloatElectricalCurrent>
{
    ...
    /**
     * Construct a new Relative Immutable FloatElectricalCurrentMatrix.
     * @param values FloatElectricalCurrent; the values of the entries in the new Relative Immutable FloatElectricalCurrentMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatElectricalCurrentMatrix(final FloatElectricalCurrent[][] values, final StorageType storageType) throws ValueException
    {
