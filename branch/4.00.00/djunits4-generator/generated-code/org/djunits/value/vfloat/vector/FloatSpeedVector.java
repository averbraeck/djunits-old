...
public class FloatSpeedVector extends
    AbstractFloatVectorRel<SpeedUnit, FloatSpeedVector, MutableFloatSpeedVector, FloatSpeed>
{
    /** */
     ...
     */
    public FloatSpeedVector(final float[] values, final SpeedUnit unit, final StorageType storageType)
    ...
    /**
     * Construct a new Relative Immutable Float FloatSpeedVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatSpeedVector
