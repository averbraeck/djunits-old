...
public class MutableFloatSpeedVector extends
    AbstractMutableFloatVectorRel<SpeedUnit, FloatSpeedVector, MutableFloatSpeedVector, FloatSpeed> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Float SpeedVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float SpeedVector
