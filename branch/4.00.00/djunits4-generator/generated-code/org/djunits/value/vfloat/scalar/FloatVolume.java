 ...
 * <pre>FloatScalar.Rel&lt;VolumeUnit&gt; value = new FloatScalar.Rel&lt;VolumeUnit&gt;(100.0, VolumeUnit.SI);</pre>
 * we can now write:
 * <pre>FloatVolume value = new FloatVolume(100.0, VolumeUnit.SI);</pre>
...
public class FloatVolume extends AbstractFloatScalarRel<VolumeUnit, FloatVolume> 
{
    ...
    {
        return new FloatVolume(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
    ...
    /**
     * Returns a FloatVolume representation of a textual representation of a value with a unit. The String representation that can be
