 ...
 * <pre>FloatScalar.Rel&lt;ForceUnit&gt; value = new FloatScalar.Rel&lt;ForceUnit&gt;(100.0, ForceUnit.SI);</pre>
 * we can now write:
 * <pre>FloatForce value = new FloatForce(100.0, ForceUnit.SI);</pre>
...
public class FloatForce extends AbstractFloatScalarRel<ForceUnit, FloatForce> 
{
    ...
    {
        return new FloatForce(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
    ...
    /**
     * Returns a FloatForce representation of a textual representation of a value with a unit. The String representation that can be
