 ...
 */
public class FloatFlowVolumeVector extends
    AbstractFloatVectorRel<FlowVolumeUnit, FloatFlowVolumeVector, MutableFloatFlowVolumeVector, FloatFlowVolume>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Float FloatFlowVolumeVector.
     * @param values List&lt;FloatFlowVolume&gt;; the values of the entries in the new Relative Immutable Float FloatFlowVolumeVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public FloatFlowVolumeVector(final SortedMap<Integer, FloatFlowVolume> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatFlowVolumeVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatFlowVolumeVector
