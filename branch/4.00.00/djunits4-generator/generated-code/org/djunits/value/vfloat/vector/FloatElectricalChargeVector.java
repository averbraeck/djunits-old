...
public class FloatElectricalChargeVector extends
    AbstractFloatVectorRel<ElectricalChargeUnit, FloatElectricalChargeVector, MutableFloatElectricalChargeVector, FloatElectricalCharge>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalChargeVector.
     * @param values List&lt;Float&gt;; the values of the entries in the new Relative Immutable Float FloatElectricalChargeVector
     * @param unit ElectricalChargeUnit; the unit of the new Relative Immutable Float FloatElectricalChargeVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalChargeVector.
     * @param values FloatElectricalCharge[]; the values of the entries in the new Relative Immutable Float FloatElectricalChargeVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatElectricalChargeVector(final FloatElectricalCharge[] values, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalChargeVector.
     * @param values List&lt;FloatElectricalCharge&gt;; the values of the entries in the new Relative Immutable Float FloatElectricalChargeVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatElectricalChargeVector(final List<FloatElectricalCharge> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public FloatElectricalChargeVector(final SortedMap<Integer, FloatElectricalCharge> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatElectricalChargeVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatElectricalChargeVector
     * @param unit ElectricalChargeUnit; the unit of the new Relative Sparse Mutable Float FloatElectricalChargeVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    public FloatElectricalChargeVector(final SortedMap<Integer, Float> values, final ElectricalChargeUnit unit, final int length,
