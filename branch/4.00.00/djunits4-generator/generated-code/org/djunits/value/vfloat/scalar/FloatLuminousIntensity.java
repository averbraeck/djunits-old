 ...
 * <pre>FloatScalar.Rel&lt;LuminousIntensityUnit&gt; value = new FloatScalar.Rel&lt;LuminousIntensityUnit&gt;(100.0, LuminousIntensityUnit.SI);</pre>
 * we can now write:
 * <pre>FloatLuminousIntensity value = new FloatLuminousIntensity(100.0, LuminousIntensityUnit.SI);</pre>
...
public class FloatLuminousIntensity extends AbstractFloatScalarRel<LuminousIntensityUnit, FloatLuminousIntensity> 
{
    ...
    public static FloatLuminousIntensity valueOf(final String text) throws IllegalArgumentException
    {
        ...
        {
            throw new IllegalArgumentException("Error parsing FloatLuminousIntensity -- null or empty argument");
        }
