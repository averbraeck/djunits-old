...
public class MutableFloatPressureVector extends
    AbstractMutableFloatVectorRel<PressureUnit, FloatPressureVector, MutableFloatPressureVector, FloatPressure> 
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatPressureVector(final SortedMap<Integer, FloatPressure> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float PressureVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float PressureVector
    ...
    {
        return this.data.isSparse() ? (MutableFloatPressureVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
