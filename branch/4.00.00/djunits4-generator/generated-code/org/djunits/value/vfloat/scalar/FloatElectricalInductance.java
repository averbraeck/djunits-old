...
/**
 * Easy access methods for the ElectricalInductance FloatScalar, which is relative by definition. An example is Speed. Instead of:
 * <pre>FloatScalar.Rel&lt;ElectricalInductanceUnit&gt; value = new FloatScalar.Rel&lt;ElectricalInductanceUnit&gt;(100.0, ElectricalInductanceUnit.SI);</pre>
 * we can now write:
 * <pre>FloatElectricalInductance value = new FloatElectricalInductance(100.0, ElectricalInductanceUnit.SI);</pre>
...
public class FloatElectricalInductance extends AbstractFloatScalarRel<ElectricalInductanceUnit, FloatElectricalInductance> 
{
    ...
    {
        return new FloatElectricalInductance(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
