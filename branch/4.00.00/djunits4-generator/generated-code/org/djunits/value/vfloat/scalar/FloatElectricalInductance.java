...
public class FloatElectricalInductance extends AbstractFloatScalarRel<ElectricalInductanceUnit, FloatElectricalInductance> 
{
    ...
    {
        Throw.whenNull(text, "Error parsing FloatElectricalInductance: unitString is null");
        Throw.when(text.length() == 0, IllegalArgumentException.class, "Error parsing FloatElectricalInductance: empty unitString");
