...
public class MutableFloatLuminousIntensityMatrix extends
    AbstractMutableFloatMatrixRel<LuminousIntensityUnit, FloatLuminousIntensityMatrix, MutableFloatLuminousIntensityMatrix, FloatLuminousIntensity> 
{
    /** */
     ...
     */
    public MutableFloatLuminousIntensityMatrix(final float[][] values, final LuminousIntensityUnit unit, final StorageType storageType)
     ...
     */
    public MutableFloatLuminousIntensityMatrix(final FloatLuminousIntensity[][] values, final StorageType storageType) throws ValueException
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatLuminousIntensityMatrix instantiateMutableType(final FloatMatrixData fmd, final LuminousIntensityUnit unit)
    {
