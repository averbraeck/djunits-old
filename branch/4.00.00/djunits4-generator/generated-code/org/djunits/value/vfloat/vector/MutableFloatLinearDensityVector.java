...
public class MutableFloatLinearDensityVector extends
    AbstractMutableFloatVectorRel<LinearDensityUnit, FloatLinearDensityVector, MutableFloatLinearDensityVector, FloatLinearDensity> 
{
    /** */
     ...
     * @throws ValueException when values is null
     */
    public MutableFloatLinearDensityVector(final List<Float> values, final LinearDensityUnit unit, final StorageType storageType)
        throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MutableFloatLinearDensityVector(final FloatLinearDensity[] values, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float LinearDensityVector.
     * @param values List&lt;FloatLinearDensity&gt;; the values of the entries in the new Relative Immutable Float LinearDensityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableFloatLinearDensityVector(final List<FloatLinearDensity> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Float LinearDensityVector.
     * @param values SortedMap&lt;Integer, FloatLinearDensity&gt;; the values of the entries in the new Relative Sparse Mutable Float
     *            LinearDensityVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableFloatLinearDensityVector(final SortedMap<Integer, FloatLinearDensity> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float LinearDensityVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float LinearDensityVector
     * @param unit LinearDensityUnit; the unit of the new Relative Sparse Mutable Float LinearDensityVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    public MutableFloatLinearDensityVector(final SortedMap<Integer, Float> values, final LinearDensityUnit unit, final int length,
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatLinearDensityVector instantiateMutableType(final FloatVectorData dvd, final LinearDensityUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableFloatLinearDensityVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatLinearDensityVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
