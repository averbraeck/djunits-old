...
/**
 * Easy access methods for the MagneticFluxDensity FloatScalar, which is relative by definition. An example is Speed. Instead of:
 * <pre>FloatScalar.Rel&lt;MagneticFluxDensityUnit&gt; value = new FloatScalar.Rel&lt;MagneticFluxDensityUnit&gt;(100.0, MagneticFluxDensityUnit.SI);</pre>
 * we can now write:
 * <pre>FloatMagneticFluxDensity value = new FloatMagneticFluxDensity(100.0, MagneticFluxDensityUnit.SI);</pre>
...
public class FloatMagneticFluxDensity extends AbstractFloatScalarRel<MagneticFluxDensityUnit, FloatMagneticFluxDensity> 
{
    ...
    {
        return new FloatMagneticFluxDensity(zero.getInUnit() * (1 - ratio) + one.getInUnit(zero.getUnit()) * ratio, zero
            .getUnit());
    }
