...
public class FloatPressureVector extends
    AbstractFloatVectorRel<PressureUnit, FloatPressureVector, MutableFloatPressureVector, FloatPressure>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Float FloatPressureVector.
     * @param values List&lt;FloatPressure&gt;; the values of the entries in the new Relative Immutable Float FloatPressureVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatPressureVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatPressureVector
