    ...
    AbstractFloatVectorRel<LuminousFluxUnit, FloatLuminousFluxVector, MutableFloatLuminousFluxVector, FloatLuminousFlux>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatLuminousFluxVector.
     * @param values List&lt;FloatLuminousFlux&gt;; the values of the entries in the new Relative Immutable Float FloatLuminousFluxVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public FloatLuminousFluxVector(final SortedMap<Integer, FloatLuminousFlux> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float FloatLuminousFluxVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatLuminousFluxVector
