...
public class FloatAbsoluteTemperatureMatrix extends
        AbstractFloatMatrixAbs<AbsoluteTemperatureUnit, TemperatureUnit, FloatAbsoluteTemperatureMatrix, FloatTemperatureMatrix, MutableFloatAbsoluteTemperatureMatrix, FloatAbsoluteTemperature>
{
    /** */
     ...
     */
    public FloatAbsoluteTemperatureMatrix(final float[][] values, final AbsoluteTemperatureUnit unit, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Absolute Immutable FloatAbsoluteTemperatureMatrix.
     * @param values FloatAbsoluteTemperature[][]; the values of the entries in the new Absolute Immutable FloatAbsoluteTemperatureMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public FloatAbsoluteTemperatureMatrix(final FloatAbsoluteTemperature[][] values, final StorageType storageType) throws ValueException
    {
