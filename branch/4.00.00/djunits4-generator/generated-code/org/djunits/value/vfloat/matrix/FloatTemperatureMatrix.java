...
public class FloatTemperatureMatrix extends AbstractFloatMatrixRel<TemperatureUnit, FloatTemperatureMatrix, MutableFloatTemperatureMatrix, FloatTemperature>
{
     ...
     */
    public FloatTemperatureMatrix(final float[][] values, final TemperatureUnit unit, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable FloatTemperatureMatrix.
     * @param values FloatScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Relative Immutable FloatTemperatureMatrix
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatTemperatureMatrix
        instantiateMutableType(final FloatMatrixData fmd, final TemperatureUnit unit)
    {
