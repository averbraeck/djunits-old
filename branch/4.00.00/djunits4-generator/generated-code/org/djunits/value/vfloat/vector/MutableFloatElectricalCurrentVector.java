    ...
    AbstractMutableFloatVectorRel<ElectricalCurrentUnit, FloatElectricalCurrentVector, MutableFloatElectricalCurrentVector, FloatElectricalCurrent> 
{
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCurrentVector.
     * @param values FloatElectricalCurrent[]; the values of the entries in the new Relative Immutable Float ElectricalCurrentVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCurrentVector.
     * @param values List&lt;FloatElectricalCurrent&gt;; the values of the entries in the new Relative Immutable Float ElectricalCurrentVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float ElectricalCurrentVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float ElectricalCurrentVector
