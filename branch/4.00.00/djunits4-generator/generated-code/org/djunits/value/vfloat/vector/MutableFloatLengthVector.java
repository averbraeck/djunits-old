...
public class MutableFloatLengthVector extends AbstractMutableFloatVectorRel<LengthUnit, FloatLengthVector, MutableFloatLengthVector, FloatLength>
{
     ...
     */
    public MutableFloatLengthVector(final float[] values, final LengthUnit unit, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableFloatLengthVector(final List<Float> values, final LengthUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatLengthVector(final SortedMap<Integer, FloatLength> values, final int length, final StorageType storageType)
