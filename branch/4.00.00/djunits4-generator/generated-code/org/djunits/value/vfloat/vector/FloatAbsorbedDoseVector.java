    ...
    AbstractFloatVectorRel<AbsorbedDoseUnit, FloatAbsorbedDoseVector, MutableFloatAbsorbedDoseVector, FloatAbsorbedDose>
{
    ...
    /**
     * Construct a new Relative Immutable Float FloatAbsorbedDoseVector.
     * @param values List&lt;FloatAbsorbedDose&gt;; the values of the entries in the new Relative Immutable Float FloatAbsorbedDoseVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float FloatAbsorbedDoseVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float FloatAbsorbedDoseVector
