 ...
 */
public class MutableFloatLuminousFluxVector extends
    AbstractMutableFloatVectorRel<LuminousFluxUnit, FloatLuminousFluxVector, MutableFloatLuminousFluxVector, FloatLuminousFlux> 
{
    /** */
     ...
     * @param unit U; the unit of the new Relative Immutable Float LuminousFluxVector
    ...
    /**
     * Construct a new Relative Immutable Float LuminousFluxVector.
     * @param values List; the values of the entries in the new Relative Immutable Float LuminousFluxVector
     * @param unit U; the unit of the new Relative Immutable Float LuminousFluxVector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatLuminousFluxVector(final List<FloatLuminousFlux> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatLuminousFluxVector(final SortedMap<Integer, FloatLuminousFlux> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Float LuminousFluxVector.
     * @param values Map; the map of indexes to values of the Relative Sparse Mutable Float LuminousFluxVector
     * @param unit U; the unit of the new Relative Sparse Mutable Float LuminousFluxVector
     * @param length the size of the vector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableFloatLuminousFluxVector instantiateMutableType(final FloatVectorData dvd, final LuminousFluxUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableFloatLuminousFluxVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableFloatLuminousFluxVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
