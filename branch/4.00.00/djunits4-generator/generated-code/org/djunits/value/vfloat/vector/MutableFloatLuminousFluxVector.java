    ...
    AbstractMutableFloatVectorRel<LuminousFluxUnit, FloatLuminousFluxVector, MutableFloatLuminousFluxVector, FloatLuminousFlux> 
{
    ...
    /**
     * Construct a new Relative Immutable Float LuminousFluxVector.
     * @param values List&lt;FloatLuminousFlux&gt;; the values of the entries in the new Relative Immutable Float LuminousFluxVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Float LuminousFluxVector.
     * @param values SortedMap&lt;Integer, FloatLuminousFlux&gt;; the values of the entries in the new Relative Sparse Mutable Float
     *            LuminousFluxVector
    ...
    /**
     * Construct a new Relative Immutable Float LuminousFluxVector.
     * @param values SortedMap&lt;Integer, Float&gt;; the map of indexes to values of the Relative Sparse Mutable Float LuminousFluxVector
