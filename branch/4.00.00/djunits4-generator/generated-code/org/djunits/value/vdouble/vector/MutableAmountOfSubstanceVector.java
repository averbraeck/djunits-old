 ...
 */
public class MutableAmountOfSubstanceVector extends
    AbstractMutableDoubleVectorRel<AmountOfSubstanceUnit, AmountOfSubstanceVector, MutableAmountOfSubstanceVector, AmountOfSubstance> 
{
    /** */
     ...
     */
    public MutableAmountOfSubstanceVector(final double[] values, final AmountOfSubstanceUnit unit, final StorageType storageType)
     ...
     * @throws ValueException when values is null
     */
    public MutableAmountOfSubstanceVector(final List<Double> values, final AmountOfSubstanceUnit unit, final StorageType storageType)
        throws ValueException
    {
        super(values, unit, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Double AmountOfSubstanceVector.
     * @param values List&lt;AmountOfSubstance&gt;; the values of the entries in the new Relative Immutable Double AmountOfSubstanceVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableAmountOfSubstanceVector(final List<AmountOfSubstance> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Double AmountOfSubstanceVector.
     * @param values SortedMap&lt;Integer, AmountOfSubstance&gt;; the values of the entries in the new Relative Sparse Mutable Double
     *            AmountOfSubstanceVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableAmountOfSubstanceVector(final SortedMap<Integer, AmountOfSubstance> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double AmountOfSubstanceVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double AmountOfSubstanceVector
     * @param unit AmountOfSubstanceUnit; the unit of the new Relative Sparse Mutable Double AmountOfSubstanceVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    public MutableAmountOfSubstanceVector(final SortedMap<Integer, Double> values, final AmountOfSubstanceUnit unit, final int length,
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableAmountOfSubstanceVector instantiateMutableType(final DoubleVectorData dvd, final AmountOfSubstanceUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableAmountOfSubstanceVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableAmountOfSubstanceVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
