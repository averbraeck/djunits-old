...
public class MutableForceVector extends
    AbstractMutableDoubleVectorRel<ForceUnit, ForceVector, MutableForceVector, Force> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double ForceVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double ForceVector
