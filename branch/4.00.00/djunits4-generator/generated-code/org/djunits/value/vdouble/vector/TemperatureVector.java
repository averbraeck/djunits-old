...
public class TemperatureVector extends AbstractDoubleVectorRel<TemperatureUnit, TemperatureVector, MutableTemperatureVector, Temperature>
{
    ...
    /**
     * Construct a new Relative Immutable Double TemperatureVector.
     * @param values SortedMap&lt;Integer, Temperature&gt;; the values of the entries in the new Relative Sparse Mutable Double TemperatureVector
    ...
    /**
     * Construct a new Relative Immutable Double TemperatureVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double TemperatureVector
