 ...
 */
public class MutableIlluminanceVector extends
    AbstractMutableDoubleVectorRel<IlluminanceUnit, IlluminanceVector, MutableIlluminanceVector, Illuminance> 
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableIlluminanceVector(final SortedMap<Integer, Illuminance> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double IlluminanceVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double IlluminanceVector
