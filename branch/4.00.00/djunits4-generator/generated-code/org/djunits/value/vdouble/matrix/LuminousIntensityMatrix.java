...
AbstractDoubleMatrixRel<LuminousIntensityUnit, LuminousIntensityMatrix, MutableLuminousIntensityMatrix, LuminousIntensity>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double LuminousIntensityMatrix.
     * @param values LuminousIntensity[][]; the values of the entries in the new Relative Immutable Double LuminousIntensityMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
