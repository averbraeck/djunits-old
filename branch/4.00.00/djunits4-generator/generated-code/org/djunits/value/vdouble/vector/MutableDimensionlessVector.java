...
public class MutableDimensionlessVector extends
    AbstractMutableDoubleVectorRel<DimensionlessUnit, DimensionlessVector, MutableDimensionlessVector, Dimensionless>  implements MathFunctionsDimensionless<MutableDimensionlessVector>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double DimensionlessVector.
     * @param values List&lt;Dimensionless&gt;; the values of the entries in the new Relative Immutable Double DimensionlessVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Double DimensionlessVector.
     * @param values SortedMap&lt;Integer, Dimensionless&gt;; the values of the entries in the new Relative Sparse Mutable Double
     *            DimensionlessVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableDimensionlessVector(final SortedMap<Integer, Dimensionless> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double DimensionlessVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double DimensionlessVector
    ...
    {
        return this.data.isSparse() ? (MutableDimensionlessVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
