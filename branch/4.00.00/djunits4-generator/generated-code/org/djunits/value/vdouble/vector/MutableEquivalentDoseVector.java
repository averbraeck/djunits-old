    ...
    AbstractMutableDoubleVectorRel<EquivalentDoseUnit, EquivalentDoseVector, MutableEquivalentDoseVector, EquivalentDose> 
{
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableEquivalentDoseVector(final SortedMap<Integer, EquivalentDose> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    {
        return this.data.isDense() ? (MutableEquivalentDoseVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableEquivalentDoseVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
