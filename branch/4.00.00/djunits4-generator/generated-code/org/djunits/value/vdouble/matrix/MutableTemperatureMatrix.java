...
public class MutableTemperatureMatrix extends AbstractMutableDoubleMatrixRel<TemperatureUnit, TemperatureMatrix, MutableTemperatureMatrix, Temperature>
{
     ...
     */
    public MutableTemperatureMatrix(final double[][] values, final TemperatureUnit unit, final StorageType storageType) throws ValueException
    {
    ...
    /**
     * Construct a new Relative Mutable Double TemperatureMatrix.
     * @param values DoubleScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Relative Mutable Double TemperatureMatrix
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableTemperatureMatrix
        instantiateMutableType(final DoubleMatrixData dmd, final TemperatureUnit unit)
    {
