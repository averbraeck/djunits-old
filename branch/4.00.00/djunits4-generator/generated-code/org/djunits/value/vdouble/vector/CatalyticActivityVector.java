...
public class CatalyticActivityVector extends
    AbstractDoubleVectorRel<CatalyticActivityUnit, CatalyticActivityVector, MutableCatalyticActivityVector, CatalyticActivity>
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public CatalyticActivityVector(final SortedMap<Integer, CatalyticActivity> values, final int length, final StorageType storageType)
        throws ValueException
    {
