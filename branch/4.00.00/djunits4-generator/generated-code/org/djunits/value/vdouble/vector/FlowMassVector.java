...
public class FlowMassVector extends
    AbstractDoubleVectorRel<FlowMassUnit, FlowMassVector, MutableFlowMassVector, FlowMass>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double FlowMassVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double FlowMassVector
