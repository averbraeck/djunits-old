 ...
 * <pre>DoubleScalar.Rel&lt;MagneticFluxUnit&gt; value = new DoubleScalar.Rel&lt;MagneticFluxUnit&gt;(100.0,
 * MagneticFluxUnit.SI);</pre>
 * we can now write:
 * <pre>MagneticFlux value = new MagneticFlux(100.0, MagneticFluxUnit.SI);</pre>
