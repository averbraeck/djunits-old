    ...
    AbstractMutableDoubleVectorRel<ElectricalCurrentUnit, ElectricalCurrentVector, MutableElectricalCurrentVector, ElectricalCurrent> 
{
     ...
     * @throws ValueException when values is null
     */
    public MutableElectricalCurrentVector(final List<Double> values, final ElectricalCurrentUnit unit, final StorageType storageType)
        throws ValueException
    {
        super(values, unit, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalCurrentVector.
     * @param values List&lt;ElectricalCurrent&gt;; the values of the entries in the new Relative Immutable Double ElectricalCurrentVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalCurrentVector(final List<ElectricalCurrent> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalCurrentVector.
     * @param values SortedMap&lt;Integer, ElectricalCurrent&gt;; the values of the entries in the new Relative Sparse Mutable Double
     *            ElectricalCurrentVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalCurrentVector(final SortedMap<Integer, ElectricalCurrent> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalCurrentVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double ElectricalCurrentVector
     * @param unit ElectricalCurrentUnit; the unit of the new Relative Sparse Mutable Double ElectricalCurrentVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    public MutableElectricalCurrentVector(final SortedMap<Integer, Double> values, final ElectricalCurrentUnit unit, final int length,
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableElectricalCurrentVector instantiateMutableType(final DoubleVectorData dvd, final ElectricalCurrentUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableElectricalCurrentVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableElectricalCurrentVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
