    ...
    AbstractMutableDoubleMatrixRel<ElectricalCurrentUnit, ElectricalCurrentMatrix, MutableElectricalCurrentMatrix, ElectricalCurrent> 
{
     ...
     */
    public MutableElectricalCurrentMatrix(final double[][] values, final ElectricalCurrentUnit unit, final StorageType storageType)
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalCurrentMatrix.
     * @param values %TypeAbs%[][]; the values of the entries in the new Relative Immutable Double ElectricalCurrentMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalCurrentMatrix(final ElectricalCurrent[][] values, final StorageType storageType) throws ValueException
    {
