    ...
    AbstractMutableDoubleVectorRel<RadioActivityUnit, RadioActivityVector, MutableRadioActivityVector, RadioActivity> 
{
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableRadioActivityVector(final SortedMap<Integer, RadioActivity> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    {
        return this.data.isSparse() ? (MutableRadioActivityVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
