 ...
 */
public class MutableMassVector extends
    AbstractMutableDoubleVectorRel<MassUnit, MassVector, MutableMassVector, Mass> 
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double MassVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double MassVector
