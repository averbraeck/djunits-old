...
public class TimeVector extends
    AbstractDoubleVectorAbs<TimeUnit, DurationUnit, TimeVector, DurationVector, MutableTimeVector, Time>
{
    /** */
    ...
    /**
     * Construct a new Absolute Immutable Double TimeVector.
     * @param values SortedMap&lt;Integer, Time&gt;; the values of the entries in the new Absolute Sparse Mutable Double TimeVector
    ...
    /**
     * Construct a new Absolute Immutable Double TimeVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Absolute Sparse Mutable Double TimeVector
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableTimeVector
        instantiateMutableType(final DoubleVectorData dvd, final TimeUnit unit)
    {
