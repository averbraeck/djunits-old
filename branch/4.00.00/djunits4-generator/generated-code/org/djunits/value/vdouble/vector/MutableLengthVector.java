...
public class MutableLengthVector extends AbstractMutableDoubleVectorRel<LengthUnit, LengthVector, MutableLengthVector, Length>
{
     ...
     */
    public MutableLengthVector(final double[] values, final LengthUnit unit, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableLengthVector(final List<Double> values, final LengthUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
