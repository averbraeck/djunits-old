 ...
 */
public class ElectricalConductanceMatrix extends
AbstractDoubleMatrixRel<ElectricalConductanceUnit, ElectricalConductanceMatrix, MutableElectricalConductanceMatrix, ElectricalConductance>
{
    /** */
     ...
     */
    public ElectricalConductanceMatrix(final double[][] values, final ElectricalConductanceUnit unit, final StorageType storageType)
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalConductanceMatrix.
     * @param values ElectricalConductance[][]; the values of the entries in the new Relative Immutable Double ElectricalConductanceMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public ElectricalConductanceMatrix(final ElectricalConductance[][] values, final StorageType storageType) throws ValueException
    {
