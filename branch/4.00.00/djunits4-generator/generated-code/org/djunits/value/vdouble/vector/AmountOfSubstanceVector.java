...
public class AmountOfSubstanceVector extends
    AbstractDoubleVectorRel<AmountOfSubstanceUnit, AmountOfSubstanceVector, MutableAmountOfSubstanceVector, AmountOfSubstance>
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public AmountOfSubstanceVector(final SortedMap<Integer, AmountOfSubstance> values, final int length, final StorageType storageType)
        throws ValueException
    {
