...
public class MutableAccelerationVector extends
    AbstractMutableDoubleVectorRel<AccelerationUnit, AccelerationVector, MutableAccelerationVector, Acceleration> 
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAccelerationVector(final SortedMap<Integer, Acceleration> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double AccelerationVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double AccelerationVector
    ...
    {
        return this.data.isSparse() ? (MutableAccelerationVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
