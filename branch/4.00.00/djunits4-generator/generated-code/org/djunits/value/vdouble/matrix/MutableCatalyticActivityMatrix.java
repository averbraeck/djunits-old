 ...
 */
public class MutableCatalyticActivityMatrix extends
    AbstractMutableDoubleMatrixRel<CatalyticActivityUnit, CatalyticActivityMatrix, MutableCatalyticActivityMatrix, CatalyticActivity> 
{
    /** */
     ...
     */
    public MutableCatalyticActivityMatrix(final double[][] values, final CatalyticActivityUnit unit, final StorageType storageType)
     ...
     */
    public MutableCatalyticActivityMatrix(final CatalyticActivity[][] values, final StorageType storageType) throws ValueException
    {
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableCatalyticActivityMatrix instantiateMutableType(final DoubleMatrixData dmd, final CatalyticActivityUnit unit)
    {
