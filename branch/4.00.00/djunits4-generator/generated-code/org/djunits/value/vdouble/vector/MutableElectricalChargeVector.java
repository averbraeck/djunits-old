    ...
    AbstractMutableDoubleVectorRel<ElectricalChargeUnit, ElectricalChargeVector, MutableElectricalChargeVector, ElectricalCharge> 
{
     ...
     * @throws ValueException when values is null
     */
    public MutableElectricalChargeVector(final List<Double> values, final ElectricalChargeUnit unit, final StorageType storageType)
        throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalChargeVector(final List<ElectricalCharge> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalChargeVector(final SortedMap<Integer, ElectricalCharge> values, final int length, final StorageType storageType)
        throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableElectricalChargeVector(final SortedMap<Integer, Double> values, final ElectricalChargeUnit unit, final int length,
    ...
    {
        return this.data.isDense() ? (MutableElectricalChargeVector) this : instantiateMutableType(this.data.toDense(), getUnit());
    }
    ...
    {
        return this.data.isSparse() ? (MutableElectricalChargeVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
