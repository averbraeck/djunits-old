...
public class MutableAbsorbedDoseVector extends
    AbstractMutableDoubleVectorRel<AbsorbedDoseUnit, AbsorbedDoseVector, MutableAbsorbedDoseVector, AbsorbedDose> 
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableAbsorbedDoseVector(final SortedMap<Integer, AbsorbedDose> values, final int length, final StorageType storageType)
        throws ValueException
    {
    ...
    /**
     * Construct a new Relative Immutable Double AbsorbedDoseVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Relative Sparse Mutable Double AbsorbedDoseVector
    ...
    {
        return this.data.isSparse() ? (MutableAbsorbedDoseVector) this : instantiateMutableType(this.data.toSparse(), getUnit());
    }
