...
public class TimeMatrix extends
        AbstractDoubleMatrixAbs<TimeUnit, DurationUnit, TimeMatrix, DurationMatrix, MutableTimeMatrix, Time>
{
    /** */
    ...
    /**
     * Construct a new Absolute Immutable Double DurationMatrix.
     * @param values DoubleScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Absolute Immutable Double DurationMatrix
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
