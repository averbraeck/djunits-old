...
public class MutableTimeVector
        extends
        AbstractMutableDoubleVectorAbs<TimeUnit, DurationUnit, TimeVector, DurationVector, MutableTimeVector, Time>
{
    /** */
     ...
     * @throws ValueException when values is null
     */
    public MutableTimeVector(final List<Double> values, final TimeUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
