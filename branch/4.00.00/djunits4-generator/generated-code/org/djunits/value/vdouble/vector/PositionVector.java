...
public class PositionVector extends
    AbstractDoubleVectorAbs<PositionUnit, LengthUnit, PositionVector, LengthVector, MutablePositionVector, Position>
{
    /** */
     ...
     * @throws ValueException when values is null
     */
    public PositionVector(final List<Double> values, final PositionUnit unit, final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
    ...
    /**
     * Construct a new Absolute Immutable Double PositionVector.
     * @param values SortedMap&lt;Integer, Position&gt;; the values of the entries in the new Absolute Sparse Mutable Double PositionVector
    ...
    /**
     * Construct a new Absolute Immutable Double PositionVector.
     * @param values SortedMap&lt;Integer, Double&gt;; the map of indexes to values of the Absolute Sparse Mutable Double PositionVector
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutablePositionVector
        instantiateMutableType(final DoubleVectorData dvd, final PositionUnit unit)
    {
