...
public class FloatScalarTest
{
    ...
    public final void basicsAbsTest()
    {
        ...
        assertEquals("-200 Celsius roughly equivalent to 73 Kelvin", 73.0d, mfs.getSI(), 1.0d);
        ...
        {
            float v = i / 10.0f;
            mfs = new FloatScalar.Abs<AbsoluteTemperatureUnit, TemperatureUnit>(v, AbsoluteTemperatureUnit.DEFAULT);
