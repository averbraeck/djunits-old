...
public class FloatMatrixDenseTest
{
     ...
     */
    public static void compareMatrix(float[][] reference, float[][] result)
    {
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            assertEquals("Value in Fahrenheit", 100.4, temperatureFM.getInUnit(0, 0, AbsoluteTemperatureUnit.DEGREE_FAHRENHEIT),
                    0.1);
            compareMatrix(value, temperatureFM.getValuesInUnit());
            ...
            compareMatrix(value, temperatureFM.getValuesSI());
    ...
    public final void mathFunctionsTestAbsTest()
    {
        ...
        for (float seedValue : seedValues)
        {
            ...
            try
            {
                dm = new MutableFloatMatrix.Abs<PositionUnit, LengthUnit>(input, PositionUnit.METER, StorageType.DENSE);
                dm.ceil();
    ...
    public final void toStringRelTest()
    {
        try
        {
            ...
            float[][] value = data(3, 5, false, 38.0f);
            FloatMatrix.Rel<TemperatureUnit> dm = new FloatMatrix.Rel<TemperatureUnit>(value, tempUnit, StorageType.DENSE);
            String result = dm.toString(true, true);
    ...
    public final void mathFunctionsTestRelTest()
    {
        ...
        for (float seedValue : seedValues)
        {
            ...
            try
            {
                dm = new MutableFloatMatrix.Rel<LengthUnit>(input, LengthUnit.METER, StorageType.DENSE);
                dm.abs();
    ...
    public final void binaryplusOfRelDenseAndRelDenseTest()
    {
        try
        {
            float[][] leftValue = data(3, 5, false, 123.4f);
            float[][] rightValue = data(3, 5, false, 234.5f);
            FloatMatrix.Rel<LengthUnit> left = new FloatMatrix.Rel<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
            FloatMatrix.Rel<LengthUnit> right = new FloatMatrix.Rel<LengthUnit>(rightValue, LengthUnit.MILE, StorageType.DENSE);
    ...
    public final void incrementByTest()
    {
        try
        {
            ...
            MutableFloatMatrix.Rel<LengthUnit> left =
                    new MutableFloatMatrix.Rel<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
            ...
            left = new MutableFloatMatrix.Rel<LengthUnit>(leftValue, LengthUnit.MILE, StorageType.DENSE);
