...
public class CatalyticActivityMatrix extends AbstractDoubleMatrixRel<CatalyticActivityUnit, CatalyticActivityMatrix,
        MutableCatalyticActivityMatrix, CatalyticActivity>
{
    /** */
     ...
     */
    public CatalyticActivityMatrix(final CatalyticActivity[][] values, final StorageType storageType) throws ValueRuntimeException
    {
