...
public class FloatMassVector extends AbstractFloatVectorRel<MassUnit, FloatMassVector, MutableFloatMassVector, FloatMass>
{
     ...
     */
    public FloatMassVector(final float[] values, final MassUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values is null
     */
    public FloatMassVector(final List<Float> values, final MassUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public FloatMassVector(final FloatMass[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public FloatMassVector(final List<FloatMass> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
