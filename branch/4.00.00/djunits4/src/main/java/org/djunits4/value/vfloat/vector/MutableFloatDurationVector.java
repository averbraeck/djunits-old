...
public class MutableFloatDurationVector
        extends AbstractMutableFloatVectorRel<DurationUnit, FloatDurationVector, MutableFloatDurationVector, FloatDuration>
{
    /** */
     ...
     */
    public MutableFloatDurationVector(final float[] values, final DurationUnit unit, final StorageType storageType)
     ...
     * @throws ValueRuntimeException when values is null
     */
    public MutableFloatDurationVector(final List<Float> values, final DurationUnit unit, final StorageType storageType)
            throws ValueRuntimeException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MutableFloatDurationVector(final FloatDuration[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatDurationVector(final List<FloatDuration> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
