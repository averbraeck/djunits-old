 ...
 * for each derived unit, as this is one of the fields that will be cloned.
 * <p>
...
public abstract class AbsoluteLinearUnit<AU extends AbsoluteLinearUnit<AU, RU>, RU extends Unit<RU>> extends Unit<AU>
{
     ...
     * @param derivedAbbreviations the other valid abbreviations for the unit, e.g. {"h", "hr", "hour"}. Can be null.
    ...
    public static class Builder<AU extends AbsoluteLinearUnit<AU, RU>, RU extends Unit<RU>> extends Unit.Builder<AU>
    {
        ...
        /**
         * Return the corresponding relative unit that has the same conversion factor.
