        ...
        extends AbstractFloatVectorRel<TemperatureUnit, FloatTemperatureVector, MutableFloatTemperatureVector, FloatTemperature>
{
     ...
     */
    public FloatTemperatureVector(final FloatTemperature[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public FloatTemperatureVector(final List<FloatTemperature> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
