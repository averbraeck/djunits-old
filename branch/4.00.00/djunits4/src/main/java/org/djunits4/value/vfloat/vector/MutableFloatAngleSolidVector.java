        ...
        AbstractMutableFloatVectorRel<AngleSolidUnit, FloatAngleSolidVector, MutableFloatAngleSolidVector, FloatAngleSolid>
{
     ...
     */
    public MutableFloatAngleSolidVector(final FloatAngleSolid[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatAngleSolidVector(final List<FloatAngleSolid> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
