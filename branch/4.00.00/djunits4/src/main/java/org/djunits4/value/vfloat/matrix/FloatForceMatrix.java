...
public class FloatForceMatrix extends AbstractFloatMatrixRel<ForceUnit, FloatForceMatrix, MutableFloatForceMatrix, FloatForce>
{
     ...
     */
    public FloatForceMatrix(final float[][] values, final ForceUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public FloatForceMatrix(final FloatForce[][] values, final StorageType storageType) throws ValueRuntimeException
    {
