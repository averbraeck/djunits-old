 ...
 */
public class MutableMagneticFluxDensityVector extends AbstractMutableDoubleVectorRel<MagneticFluxDensityUnit,
        MagneticFluxDensityVector, MutableMagneticFluxDensityVector, MagneticFluxDensity>
{
    /** */
     ...
     */
    public MutableMagneticFluxDensityVector(final double[] values, final MagneticFluxDensityUnit unit,
     ...
     * @throws ValueException when values is null
     */
    public MutableMagneticFluxDensityVector(final List<Double> values, final MagneticFluxDensityUnit unit,
            final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MutableMagneticFluxDensityVector(final MagneticFluxDensity[] values, final StorageType storageType)
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMagneticFluxDensityVector(final List<MagneticFluxDensity> values, final StorageType storageType)
            throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMagneticFluxDensityVector(final SortedMap<Integer, MagneticFluxDensity> values, final int length,
            final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableMagneticFluxDensityVector(final SortedMap<Integer, Double> values, final MagneticFluxDensityUnit unit,
    ...
    {
        return this.data.isDense() ? (MutableMagneticFluxDensityVector) this
    ...
    {
        return this.data.isSparse() ? (MutableMagneticFluxDensityVector) this
