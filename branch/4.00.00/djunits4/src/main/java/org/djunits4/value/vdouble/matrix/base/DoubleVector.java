...
public final class DoubleVector
{
    ...
    /** The cache to make the lookup of the constructor for a Vector belonging to a unit faster. */
    private static Map<Unit<?>, Constructor<? extends AbstractDoubleMatrix<?, ?, ?>>> CACHE_LIST = new HashMap<>();

    /** The cache to make the lookup of the constructor for a Vector belonging to a unit faster. */
    private static Map<Unit<?>, Constructor<? extends AbstractDoubleMatrix<?, ?, ?>>> CACHE_MAP = new HashMap<>();
    ...
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiate(final double[] values, final U unit,
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiate(final List<Double> valueList, final U unit,
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiate(final Map<Integer, Double> valueMap, final U unit,
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiate(final DoubleVectorData values, final U unit)
    {
    ...
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiateAnonymous(final double[] values, final Unit<?> unit,
                    final StorageType storageType)
    {
        try
        {
            Constructor<? extends AbstractDoubleMatrix<?, ?, ?>> vectorConstructor = CACHE_ARRAY.get(unit);
            if (vectorConstructor == null)
            {
                ...
                Class<? extends AbstractDoubleMatrix<?, ?, ?>> vectorClass;
                ...
                {
                    vectorClass = (Class<AbstractDoubleMatrix<?, ?, ?>>) Class.forName("org.djunits4.value.vdouble.vector."
    ...
    @SuppressWarnings("unchecked")
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiateAnonymous(final List<Double> valueList, final Unit<?> unit,
                    final StorageType storageType)
    {
        try
        {
            Constructor<? extends AbstractDoubleMatrix<?, ?, ?>> vectorConstructor = CACHE_LIST.get(unit);
            if (vectorConstructor == null)
            {
                if (!unit.getClass().getSimpleName().endsWith("Unit"))
                {
    ...
    @SuppressWarnings("unchecked")
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiateAnonymous(final Map<Integer, Double> valueMap,
                    final Unit<?> unit, final int length, final StorageType storageType)
    {
        try
        {
            Constructor<? extends AbstractDoubleMatrix<?, ?, ?>> vectorConstructor = CACHE_MAP.get(unit);
            if (vectorConstructor == null)
            {
                if (!unit.getClass().getSimpleName().endsWith("Unit"))
                {
    ...
    protected static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V instantiateAnonymous(final DoubleVectorData values, final Unit<?> unit)
    {
        try
        {
            Constructor<? extends AbstractDoubleMatrix<?, ?, ?>> vectorConstructor = CACHE_DATA.get(unit);
            if (vectorConstructor == null)
            {
                if (!unit.getClass().getSimpleName().endsWith("Unit"))
                {
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final double[] values, final U unit,
                    final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final List<Double> values, final U unit,
                    final StorageType storageType) throws ValueRuntimeException
    {
        return instantiate(DoubleVectorData.instantiate(values, unit.getScale(), storageType), unit);
    }
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final S[] values, final StorageType storageType)
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final List<S> valueList, final StorageType storageType)
                    throws ValueRuntimeException
    {
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final SortedMap<Integer, S> valueMap, final int length,
                    final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public static <U extends Unit<U>, S extends AbstractDoubleScalar<U, S>,
            V extends AbstractDoubleMatrix<U, S, V>> V create(final SortedMap<Integer, Double> valueMap, final U unit,
