...
abstract class AbstractFloatMatrixAbs<AU extends AbsoluteLinearUnit<AU, RU>, RU extends Unit<RU>,
        ...
        AbstractFloatMatrix<AU, A> implements FunctionsAbsWithRel<AU, RU, A, R>, FloatMatrixInterface<AU>, Absolute, Serializable
{
    /** */
     ...
     */
    AbstractFloatMatrixAbs(final float[][] values, final AU unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    AbstractFloatMatrixAbs(final S[][] values, final StorageType storageType) throws ValueRuntimeException
    {
