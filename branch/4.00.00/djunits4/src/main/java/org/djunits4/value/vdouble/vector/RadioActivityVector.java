 ...
 */
public class RadioActivityVector
        extends AbstractDoubleVectorRel<RadioActivityUnit, RadioActivityVector, MutableRadioActivityVector, RadioActivity>
{
    /** */
    ...
    /**
     * Construct a new Relative Immutable Double RadioActivityVector.
     * @param values List&lt;RadioActivity&gt;; the values of the entries in the new Relative Immutable Double
     *            RadioActivityVector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    ...
    /**
     * Construct a new Relative Immutable Double RadioActivityVector.
     * @param values SortedMap&lt;Integer, RadioActivity&gt;; the values of the entries in the new Relative Sparse Mutable
     *            Double RadioActivityVector
