        ...
        extends AbstractMutableFloatVectorRel<AreaUnit, FloatAreaVector, MutableFloatAreaVector, FloatArea>
{
     ...
     */
    public MutableFloatAreaVector(final FloatArea[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatAreaVector(final List<FloatArea> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
