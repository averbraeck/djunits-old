...
public class MutableElectricalConductanceVector extends AbstractMutableDoubleVectorRel<ElectricalConductanceUnit,
        ElectricalConductanceVector, MutableElectricalConductanceVector, ElectricalConductance>
{
    /** */
     ...
     */
    public MutableElectricalConductanceVector(final double[] values, final ElectricalConductanceUnit unit,
     ...
     * @throws ValueException when values is null
     */
    public MutableElectricalConductanceVector(final List<Double> values, final ElectricalConductanceUnit unit,
            final StorageType storageType) throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MutableElectricalConductanceVector(final ElectricalConductance[] values, final StorageType storageType)
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalConductanceVector(final List<ElectricalConductance> values, final StorageType storageType)
            throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalConductanceVector(final SortedMap<Integer, ElectricalConductance> values, final int length,
            final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MutableElectricalConductanceVector(final SortedMap<Integer, Double> values, final ElectricalConductanceUnit unit,
    ...
    /** {@inheritDoc} */
    @Override
    protected final ElectricalConductanceVector instantiateType(final DoubleVectorData dvd,
    ...
    /** {@inheritDoc} */
    @Override
    protected final MutableElectricalConductanceVector instantiateMutableType(final DoubleVectorData dvd,
            final ElectricalConductanceUnit unit)
    {
    ...
    {
        return this.data.isDense() ? (MutableElectricalConductanceVector) this
    ...
    {
        return this.data.isSparse() ? (MutableElectricalConductanceVector) this
