        ...
        extends AbstractMutableFloatVectorRel<PressureUnit, FloatPressureVector, MutableFloatPressureVector, FloatPressure>
{
     ...
     */
    public MutableFloatPressureVector(final FloatPressure[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatPressureVector(final List<FloatPressure> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
