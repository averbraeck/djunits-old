        ...
        extends AbstractMutableFloatVectorRel<AngleUnit, FloatAngleVector, MutableFloatAngleVector, FloatAngle>
{
     ...
     */
    public MutableFloatAngleVector(final FloatAngle[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatAngleVector(final List<FloatAngle> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
