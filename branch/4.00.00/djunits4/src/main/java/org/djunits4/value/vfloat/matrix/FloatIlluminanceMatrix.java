        ...
        extends AbstractFloatMatrixRel<IlluminanceUnit, FloatIlluminanceMatrix, MutableFloatIlluminanceMatrix, FloatIlluminance>
{
    ...
    /**
     * Construct a new Relative Immutable FloatIlluminanceMatrix.
     * @param values FloatIlluminance; the values of the entries in the new Relative Immutable FloatIlluminanceMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueRuntimeException when values has zero entries
     */
    public FloatIlluminanceMatrix(final FloatIlluminance[][] values, final StorageType storageType) throws ValueRuntimeException
    {
