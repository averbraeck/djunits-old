        ...
        extends AbstractMutableDoubleMatrixRel<DensityUnit, DensityMatrix, MutableDensityMatrix, Density>
{
    ...
    /**
     * Construct a new Relative Immutable Double DensityMatrix.
     * @param values %TypeAbs%[][]; the values of the entries in the new Relative Immutable Double DensityMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableDensityMatrix(final Density[][] values, final StorageType storageType) throws ValueRuntimeException
    {
