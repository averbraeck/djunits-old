        ...
        extends AbstractFloatVectorRel<TorqueUnit, FloatTorqueVector, MutableFloatTorqueVector, FloatTorque>
{
     ...
     */
    public FloatTorqueVector(final float[] values, final TorqueUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public FloatTorqueVector(final FloatTorque[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public FloatTorqueVector(final List<FloatTorque> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
