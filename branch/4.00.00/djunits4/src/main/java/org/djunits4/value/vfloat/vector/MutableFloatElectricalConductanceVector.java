...
public class MutableFloatElectricalConductanceVector extends AbstractMutableFloatVectorRel<ElectricalConductanceUnit,
        FloatElectricalConductanceVector, MutableFloatElectricalConductanceVector, FloatElectricalConductance>
{
     ...
     */
    public MutableFloatElectricalConductanceVector(final float[] values, final ElectricalConductanceUnit unit,
     ...
     * @throws ValueRuntimeException when values is null
     */
    public MutableFloatElectricalConductanceVector(final List<Float> values, final ElectricalConductanceUnit unit,
            final StorageType storageType) throws ValueRuntimeException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MutableFloatElectricalConductanceVector(final FloatElectricalConductance[] values, final StorageType storageType)
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatElectricalConductanceVector(final List<FloatElectricalConductance> values, final StorageType storageType)
            throws ValueRuntimeException
    {
        super(values, storageType);
    }
     ...
     *            Mutable Float ElectricalConductanceVector
     * @param length int; the size of the vector
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatElectricalConductanceVector(final SortedMap<Integer, FloatElectricalConductance> values,
     ...
     * @throws ValueRuntimeException when values is null
     */
    public MutableFloatElectricalConductanceVector(final SortedMap<Integer, Float> values, final ElectricalConductanceUnit unit,
            final int length, final StorageType storageType) throws ValueRuntimeException
    {
    ...
    {
        return this.data.isDense() ? (MutableFloatElectricalConductanceVector) this
    ...
    {
        return this.data.isSparse() ? (MutableFloatElectricalConductanceVector) this
