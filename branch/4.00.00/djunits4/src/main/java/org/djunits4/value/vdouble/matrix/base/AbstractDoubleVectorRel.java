...
public abstract class AbstractDoubleVectorRel<U extends Unit<U>, S extends AbstractDoubleScalarRel<U, S>,
        RV extends AbstractDoubleVectorRel<U, S, RV>> extends AbstractDoubleMatrix<U, S, RV>
        implements Vector.Rel<U, S, RV>, Relative
{
     ...
     */
    public final <VT extends AbstractDoubleMatrix<?, ?, ?> & Relative> SIVector times(final VT rel)
     ...
     * @throws UnitException on unit error
     */
    public final <VT extends AbstractDoubleMatrix<?, ?, ?> & Relative> SIVector divide(final VT rel)
            throws ValueRuntimeException, UnitException
    {
        checkSize(rel);
