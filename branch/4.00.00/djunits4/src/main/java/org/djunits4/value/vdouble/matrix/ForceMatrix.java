...
public class ForceMatrix extends AbstractDoubleMatrixRel<ForceUnit, ForceMatrix, MutableForceMatrix, Force>
{
     ...
     */
    public ForceMatrix(final double[][] values, final ForceUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public ForceMatrix(final Force[][] values, final StorageType storageType) throws ValueRuntimeException
    {
