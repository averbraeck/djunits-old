        ...
        AbstractMutableFloatVectorRel<FlowVolumeUnit, FloatFlowVolumeVector, MutableFloatFlowVolumeVector, FloatFlowVolume>
{
     ...
     */
    public MutableFloatFlowVolumeVector(final FloatFlowVolume[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatFlowVolumeVector(final List<FloatFlowVolume> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
