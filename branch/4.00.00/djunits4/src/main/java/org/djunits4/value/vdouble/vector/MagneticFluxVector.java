...
/**
 * Immutable Double MagneticFluxVector, a vector of values with a MagneticFluxUnit.
 * <p>
...
public class MagneticFluxVector
        extends AbstractDoubleVectorRel<MagneticFluxUnit, MagneticFluxVector, MutableMagneticFluxVector, MagneticFlux>
{
    /** */
     ...
     */
    public MagneticFluxVector(final double[] values, final MagneticFluxUnit unit, final StorageType storageType)
     ...
     * @throws ValueException when values is null
     */
    public MagneticFluxVector(final List<Double> values, final MagneticFluxUnit unit, final StorageType storageType)
            throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public MagneticFluxVector(final MagneticFlux[] values, final StorageType storageType) throws ValueException
    {
     ...
     * @throws ValueException when values has zero entries
     */
    public MagneticFluxVector(final List<MagneticFlux> values, final StorageType storageType) throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MagneticFluxVector(final SortedMap<Integer, MagneticFlux> values, final int length, final StorageType storageType)
            throws ValueException
    {
     ...
     * @throws ValueException when values is null
     */
    public MagneticFluxVector(final SortedMap<Integer, Double> values, final MagneticFluxUnit unit, final int length,
     ...
     */
    MagneticFluxVector(final DoubleVectorData data, final MagneticFluxUnit unit)
    {
        super(data, unit);
    }
    ...
    /** {@inheritDoc} */
    @Override
    public final MagneticFluxVector toDense()
    {
        return this.data.isDense() ? (MagneticFluxVector) this : instantiateType(this.data.toDense(), getUnit());
    }

    /** {@inheritDoc} */
    @Override
    public final MagneticFluxVector toSparse()
    {
        return this.data.isSparse() ? (MagneticFluxVector) this : instantiateType(this.data.toSparse(), getUnit());
    }
