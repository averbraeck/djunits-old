        ...
        extends AbstractFloatMatrixRel<EnergyUnit, FloatEnergyMatrix, MutableFloatEnergyMatrix, FloatEnergy>
{
     ...
     */
    public FloatEnergyMatrix(final float[][] values, final EnergyUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public FloatEnergyMatrix(final FloatEnergy[][] values, final StorageType storageType) throws ValueRuntimeException
    {
