        ...
        extends AbstractMutableFloatVectorRel<ForceUnit, FloatForceVector, MutableFloatForceVector, FloatForce>
{
     ...
     */
    public MutableFloatForceVector(final FloatForce[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public MutableFloatForceVector(final List<FloatForce> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
