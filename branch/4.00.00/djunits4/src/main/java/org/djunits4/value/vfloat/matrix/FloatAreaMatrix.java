...
public class FloatAreaMatrix extends AbstractFloatMatrixRel<AreaUnit, FloatAreaMatrix, MutableFloatAreaMatrix, FloatArea>
{
     ...
     */
    public FloatAreaMatrix(final float[][] values, final AreaUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public FloatAreaMatrix(final FloatArea[][] values, final StorageType storageType) throws ValueRuntimeException
    {
