 ...
 */
public class MutableFloatAbsorbedDoseVector extends AbstractMutableFloatVectorRel<AbsorbedDoseUnit, FloatAbsorbedDoseVector,
        MutableFloatAbsorbedDoseVector, FloatAbsorbedDose>
{
    /** */
     ...
     * @param unit U; the unit of the new Relative Immutable Float AbsorbedDoseVector
    ...
    /**
     * Construct a new Relative Immutable Float AbsorbedDoseVector.
     * @param values List; the values of the entries in the new Relative Immutable Float AbsorbedDoseVector
     * @param unit U; the unit of the new Relative Immutable Float AbsorbedDoseVector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatAbsorbedDoseVector(final List<FloatAbsorbedDose> values, final StorageType storageType)
            throws ValueException
    {
        super(values, storageType);
    }
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableFloatAbsorbedDoseVector(final SortedMap<Integer, FloatAbsorbedDose> values, final int length,
    ...
    /**
     * Construct a new Relative Immutable Float AbsorbedDoseVector.
     * @param values Map; the map of indexes to values of the Relative Sparse Mutable Float AbsorbedDoseVector
     * @param unit U; the unit of the new Relative Sparse Mutable Float AbsorbedDoseVector
     * @param length the size of the vector
     * @param storageType the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values is null
     */
    ...
    {
        return this.data.isDense() ? (MutableFloatAbsorbedDoseVector) this
    ...
    {
        return this.data.isSparse() ? (MutableFloatAbsorbedDoseVector) this
