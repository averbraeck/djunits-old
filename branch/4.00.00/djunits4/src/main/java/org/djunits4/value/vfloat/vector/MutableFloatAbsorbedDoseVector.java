        ...
        MutableFloatAbsorbedDoseVector, FloatAbsorbedDose>
{
     ...
     */
    public MutableFloatAbsorbedDoseVector(final FloatAbsorbedDose[] values, final StorageType storageType) throws ValueRuntimeException
    {
