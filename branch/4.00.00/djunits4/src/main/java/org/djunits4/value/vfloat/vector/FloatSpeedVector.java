...
public class FloatSpeedVector extends AbstractFloatVectorRel<SpeedUnit, FloatSpeedVector, MutableFloatSpeedVector, FloatSpeed>
{
     ...
     */
    public FloatSpeedVector(final float[] values, final SpeedUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values is null
     */
    public FloatSpeedVector(final List<Float> values, final SpeedUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, unit, storageType);
    }
     ...
     */
    public FloatSpeedVector(final FloatSpeed[] values, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     * @throws ValueRuntimeException when values has zero entries
     */
    public FloatSpeedVector(final List<FloatSpeed> values, final StorageType storageType) throws ValueRuntimeException
    {
        super(values, storageType);
    }
