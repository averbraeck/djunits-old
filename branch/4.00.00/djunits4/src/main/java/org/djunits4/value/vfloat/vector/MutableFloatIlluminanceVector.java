        ...
        AbstractMutableFloatVectorRel<IlluminanceUnit, FloatIlluminanceVector, MutableFloatIlluminanceVector, FloatIlluminance>
{
     ...
     */
    public MutableFloatIlluminanceVector(final FloatIlluminance[] values, final StorageType storageType) throws ValueRuntimeException
    {
    ...
    {
        return this.data.isDense() ? (MutableFloatIlluminanceVector) this
    ...
    {
        return this.data.isSparse() ? (MutableFloatIlluminanceVector) this
