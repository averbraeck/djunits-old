 ...
 * <p>
 * $LastChangedDate: 2019-03-02 19:06:46 +0100 (Sat, 02 Mar 2019) $, @version $Revision: 342 $, by $Author: pknoppers $,
...
public class ElectricalConductanceUnit extends Unit<ElectricalConductanceUnit>
{
    ...
    public static final BaseUnit<ElectricalConductanceUnit> BASE = new BaseUnit<>("s3A2/kgm2");
