...
public class MutableAreaMatrix extends AbstractMutableDoubleMatrixRel<AreaUnit, AreaMatrix, MutableAreaMatrix, Area>
{
     ...
     */
    public MutableAreaMatrix(final double[][] values, final AreaUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public MutableAreaMatrix(final Area[][] values, final StorageType storageType) throws ValueRuntimeException
    {
