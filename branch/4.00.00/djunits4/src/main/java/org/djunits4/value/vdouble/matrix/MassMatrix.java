...
public class MassMatrix extends AbstractDoubleMatrixRel<MassUnit, MassMatrix, MutableMassMatrix, Mass>
{
     ...
     */
    public MassMatrix(final double[][] values, final MassUnit unit, final StorageType storageType) throws ValueRuntimeException
    {
     ...
     */
    public MassMatrix(final Mass[][] values, final StorageType storageType) throws ValueRuntimeException
    {
