...

{
    ...
    /** {@inheritDoc} */
    @Override
    public FloatAngleSolid instantiateScalarSI(final float valueSI, final AngleSolidUnit displayUnit)
    {
        FloatAngleSolid result = FloatAngleSolid.instantiateSI(valueSI);
