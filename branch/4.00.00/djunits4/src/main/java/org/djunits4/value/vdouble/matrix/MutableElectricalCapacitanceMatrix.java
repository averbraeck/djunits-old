 ...
 */
public class MutableElectricalCapacitanceMatrix extends AbstractMutableDoubleMatrixRel<ElectricalCapacitanceUnit,
        ElectricalCapacitanceMatrix, MutableElectricalCapacitanceMatrix, ElectricalCapacitance>
{
    /** */
     ...
     */
    public MutableElectricalCapacitanceMatrix(final double[][] values, final ElectricalCapacitanceUnit unit,
    ...
    /**
     * Construct a new Relative Immutable Double ElectricalCapacitanceMatrix.
 * @param values ElectricalCapacitance[][]; the values of the entries in the new Relative Immutable Double ElectricalCapacitanceMatrix
     * @param storageType StorageType; the data type to use (e.g., DENSE or SPARSE)
     * @throws ValueException when values has zero entries
     */
    public MutableElectricalCapacitanceMatrix(final ElectricalCapacitance[][] values, final StorageType storageType)
