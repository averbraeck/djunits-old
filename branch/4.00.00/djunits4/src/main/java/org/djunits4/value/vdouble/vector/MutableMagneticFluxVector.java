 ...
 */
public class MutableMagneticFluxVector
        extends AbstractMutableDoubleVectorRel<MagneticFluxUnit, MagneticFluxVector, MutableMagneticFluxVector, MagneticFlux>
{
    /** */
     ...
     * @throws ValueException when values has zero entries
     */
    public MutableMagneticFluxVector(final SortedMap<Integer, MagneticFlux> values, final int length,
    ...
    {
        return this.data.isSparse() ? (MutableMagneticFluxVector) this
