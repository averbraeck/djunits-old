...
public class DoubleVectorSparseTest
{
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            temperatureDV = new DoubleVector.Abs.Sparse<TemperatureUnit>(value, TemperatureUnit.KELVIN);
    ...
    public final void toMutableAndBackAbsTest()
    {
        try
        {
            ...
            MutableDoubleVector.Abs.Sparse<TemperatureUnit> mdv = dv.mutable();
            checkContentsAndType(dv, value, 0.001, tempUnit, true);
            checkContentsAndType(mdv, value, 0.001, tempUnit, true);
            checkContentsAndType(dvCopy, value, 0.001, tempUnit, true);
            MutableDoubleVector.Abs.Sparse<TemperatureUnit> mdvCopy = mdv.copy();
            checkContentsAndType(mdvCopy, value, 0.001, tempUnit, true);
            MutableDoubleVector.Abs.Sparse<TemperatureUnit> mmdv = mdv.mutable();
    ...
    public final void mathFunctionsTestAbsTest()
    {
        ...
        for (double seedValue : seedValues)
        {
            ...
            MutableDoubleVector.Abs.Sparse<LengthUnit> dv;
            try
            {
    ...
    public final void binaryplusOfAbsSparseAndRelDenseTest()
    {
        try
        {
            ...
            DoubleVector.Abs.Sparse<LengthUnit> left = new DoubleVector.Abs.Sparse<LengthUnit>(leftValue, LengthUnit.MILE);
    ...
    public final void sizeCheckAbsTest()
    {
        ...
        {
            // null array
            new DoubleVector.Abs.Sparse<TemperatureUnit>((double[]) null, TemperatureUnit.DEGREE_FAHRENHEIT);
    ...
    public final void basicsRelTest()
    {
        try
        {
            ...
            temperatureDV = new DoubleVector.Rel.Sparse<TemperatureUnit>(value, TemperatureUnit.KELVIN);
    ...
    public final void toMutableAndBackRelTest()
    {
        try
        {
            ...
            MutableDoubleVector.Rel.Sparse<TemperatureUnit> mdv = dv.mutable();
            checkContentsAndType(dv, value, 0.001, tempUnit, false);
            checkContentsAndType(mdv, value, 0.001, tempUnit, false);
            checkContentsAndType(dvCopy, value, 0.001, tempUnit, false);
            MutableDoubleVector.Rel.Sparse<TemperatureUnit> mdvCopy = mdv.copy();
            checkContentsAndType(mdvCopy, value, 0.001, tempUnit, false);
            MutableDoubleVector.Rel.Sparse<TemperatureUnit> mmdv = mdv.mutable();
    ...
    public final void mathFunctionsTestRelTest()
    {
        ...
        {
            double[] input = data(3, seedValue);
            MutableDoubleVector.Rel.Sparse<LengthUnit> dv;
            try
            {
    ...
    public final void binaryplusOfRelSparseAndRelDenseTest()
    {
        try
        {
            double[] leftValue = data(3, 123.4);
            double[] rightValue = data(3, 234.5);
            DoubleVector.Rel.Sparse<LengthUnit> left = new DoubleVector.Rel.Sparse<LengthUnit>(leftValue, LengthUnit.MILE);
            DoubleVector.Rel.Dense<LengthUnit> right = new DoubleVector.Rel.Dense<LengthUnit>(rightValue, LengthUnit.MILE);
    ...
    public final void sizeCheckRelTest()
    {
        ...
        {
            // null array
            new DoubleVector.Rel.Sparse<TemperatureUnit>((double[]) null, TemperatureUnit.DEGREE_FAHRENHEIT);
            fail("Preceding code should have thrown a ValueException");
        }
        catch (ValueException ve)
        {
