...
/**
 * Easy access methods for the Force DoubleScalar. Instead of <br>
...
public interface Force extends UNITS
{
    ...
    public static class Rel extends DoubleScalar.Rel<ForceUnit>
    {
         ...
         */
        public Rel(final DoubleScalar.Rel<ForceUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Force.Rel(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Rel(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final Force.Rel divideBy(final double divisor)
        {
    ...
    public static class Abs extends DoubleScalar.Abs<ForceUnit>
    {
         ...
         * @param value Scalar from which to construct this instance
         */
        public Abs(final DoubleScalar.Abs<ForceUnit> value)
        {
            super(value);
        }
        ...
        {
            return new Force.Abs(Math.acos(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.asin(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.atan(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.cbrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.ceil(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.cos(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.cosh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.exp(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.expm1(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.floor(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.log(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.log10(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.log1p(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.rint(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.sin(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.sinh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.sqrt(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.tan(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.tanh(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(1.0 / getInUnit(), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.toDegrees(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.toRadians(getInUnit()), getUnit());
        }
        ...
        {
            return new Force.Abs(Math.pow(getInUnit(), x), getUnit());
        }
        ...
        /** {@inheritDoc} */
        @Override
        public final Force.Abs divideBy(final double divisor)
        {
