 ...
 */
public class Mutable%TypeRel%Matrix extends AbstractMutableDoubleMatrixRel<%TypeUnit%, %TypeRel%Matrix, Mutable%TypeRel%Matrix, %TypeRel%>
{
    /** */
     ...
     */
    public Mutable%TypeRel%Matrix(final double[][] values, final %TypeUnit% unit, final StorageType storageType) throws ValueException
    {
     ...
     * @param unit the unit
     */
    Mutable%TypeRel%Matrix(final DoubleMatrixData data, final %TypeUnit% unit)
    {
        super(data, unit);
    }
     ...
     */
    public final Mutable%TypeAbs%Matrix toAbs()
    {
        return new Mutable%TypeAbs%Matrix(getData(), getUnit());
    }
