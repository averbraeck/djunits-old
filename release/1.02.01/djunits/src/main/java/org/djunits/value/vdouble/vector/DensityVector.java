 ...
 */
public abstract class DensityVector extends DoubleVector.Rel<DensityUnit>
{
    /** */
     ...
     */
    public DensityVector(final DensityUnit unit)
    {
        super(unit);
    }
    ...
    /** {@inheritDoc} */
    public abstract DensityVector toDense();

    /** {@inheritDoc} */
    public abstract DensityVector toSparse();

    /**
     * Double Dense Relative Immutable Density class.
     */
    public static class Dense extends DensityVector implements DenseData
    {
        /** */
        ...
        {
            return new MutableDensityVector.Dense(getData(), getUnit());
        }
        ...
        {
            return new DensityVector.Sparse(getData().toSparse(), getUnit());
        }
    }
     ...
     */
    public static class Sparse extends DensityVector implements SparseData
    {
        /** */
        private static final long serialVersionUID = 20150905L;
        ...
        public final MutableDensityVector mutable()
        {
            return new MutableDensityVector.Sparse(getData(), getUnit());
        }
        ...
        public final DensityVector toDense()
        {
            return new DensityVector.Dense(getData().toDense(), getUnit());
        }
     ...
     * @param unit the unit to use
     * @return an DensityVector
     */
    static DensityVector instantiate(final DoubleVectorData dvData, final DensityUnit unit)
    {
        if (dvData instanceof DoubleVectorDataSparse)
        {
            return new DensityVector.Sparse((DoubleVectorDataSparse) dvData, unit);
        }
        else
        {
            return new DensityVector.Dense((DoubleVectorDataDense) dvData, unit);
        }
    }
