...
public class FloatVectorDenseTest
{
    ...
    public final void basicsAbsTest()
    {
        try
        {
            ...
            FloatVector.Abs.Dense<TemperatureUnit> temperature2FV =
                new FloatVector.Abs.Dense<TemperatureUnit>(temperatureFV.getValuesSI(), TemperatureUnit.KELVIN);
            ...
            temperatureFV = new FloatVector.Abs.Dense<TemperatureUnit>(value, TemperatureUnit.KELVIN);
    ...
    public final void toMutableAndBackAbsTest()
    {
        try
        {
            ...
            assertTrue("Different value extremely likely results in different hashCode", fv.hashCode() != mfv
                .hashCode());
    ...
    public final void mathFunctionsTestAbsTest()
    {
        ...
        for (float seedValue : seedValues)
        {
            ...
            MutableFloatVector.Abs.Dense<LengthUnit> fv;
            try
            {
                fv = new MutableFloatVector.Abs.Dense<LengthUnit>(input, LengthUnit.METER);
                fv.abs();
        ...
        try
        {
            ...
            for (int i = 0; i < leftValue.length; i++)
            {
                assertEquals("value of element should be SI plus of contributing elements", left.getSI(i)
                    + right.getSI(i), result.getSI(i), 0.001f);
            }
        }
        catch (ValueException ve)
        {
    ...
    public final void sizeCheckAbsTest()
    {
        ...
        {
            // null array
            new FloatVector.Abs.Dense<TemperatureUnit>((float[]) null, TemperatureUnit.DEGREE_FAHRENHEIT);
    ...
    public final void basicsRelTest()
    {
        try
        {
            ...
            FloatVector.Rel.Dense<TemperatureUnit> temperature2FV =
                new FloatVector.Rel.Dense<TemperatureUnit>(temperatureFV.getValuesSI(), TemperatureUnit.KELVIN);
            assertTrue("temperature2FV should be equal to temperatureFV", temperature2FV.equals(temperatureFV));
            assertTrue("Value is Relative", temperatureFV.isRelative());
            assertFalse("Value is not Absolute", temperatureFV.isAbsolute());
            temperatureFV = new FloatVector.Rel.Dense<TemperatureUnit>(value, TemperatureUnit.KELVIN);
    ...
    public final void mathFunctionsTestRelTest()
    {
        ...
        {
            float[] input = data(3, seedValue);
            MutableFloatVector.Rel.Dense<LengthUnit> fv;
            try
            {
                fv = new MutableFloatVector.Rel.Dense<LengthUnit>(input, LengthUnit.METER);
                fv.abs();
                MathTester.tester(input, "abs", fv, 0.001, new FloatToFloat()
                {
                    @Override
    ...
    public final void sizeCheckRelTest()
    {
        ...
        {
            // null array
            new FloatVector.Rel.Dense<TemperatureUnit>((float[]) null, TemperatureUnit.DEGREE_FAHRENHEIT);
            fail("Preceding code should have thrown a ValueException");
        }
        catch (ValueException ve)
        {
