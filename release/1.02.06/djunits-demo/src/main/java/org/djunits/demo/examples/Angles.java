...
public class Angles
{
    ...
    public static void main(final String[] args) throws ValueException
    {
        ...
        Angle.Rel normA1 = AngleUtil.normalize(a1);
        ...
        Angle.Rel normA2 = AngleUtil.normalize(a2);
        ...
        Angle.Rel normA3 = AngleUtil.normalize(a3);
        System.out
        ...
        Angle.Rel normA4 = AngleUtil.normalize(a4);
        ...
        Angle.Rel normA5 = AngleUtil.normalize(a5);
        ...
        Angle.Rel normA6 = AngleUtil.normalize(a6);
