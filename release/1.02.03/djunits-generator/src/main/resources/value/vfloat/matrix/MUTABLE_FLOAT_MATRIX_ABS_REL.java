 ...
 */
public interface MutableFloat%Type%Matrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        MutableTypedFloatMatrixAbs<%Type%Unit, Float%Type%Matrix.Abs, Float%Type%Matrix.Rel, MutableFloat%Type%Matrix.Abs, Float%Type%.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable Float%Type%Matrix.
         * @param values float[][]; the values of the entries in the new Absolute Mutable Float%Type%Matrix
         * @param unit U; the unit of the new Absolute Mutable Float%Type%Matrix
        ...
        /**
         * Construct a new Absolute Mutable Float%Type%Matrix.
         * @param values FloatScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Absolute Mutable Float%Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         ...
         */
        public final MutableFloat%Type%Matrix.Rel toRel()
        {
            return new MutableFloat%Type%Matrix.Rel(getData(), getUnit());
        }
...
%FORMULAS%%Type%.Abs%
     ...
     */
    class Rel extends MutableTypedFloatMatrixRel<%Type%Unit, Float%Type%Matrix.Rel, MutableFloat%Type%Matrix.Rel, Float%Type%.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable Float%Type%Matrix.
         * @param values float[][]; the values of the entries in the new Relative Mutable Float%Type%Matrix
         * @param unit U; the unit of the new Relative Mutable Float%Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable Float%Type%Matrix.
         * @param values FloatScalar.Rel&lt;U&gt;[][]; the values of the entries in the new Relative Mutable Float%Type%Matrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values has zero entries
         */
         ...
         */
        public final MutableFloat%Type%Matrix.Abs toAbs()
        {
            return new MutableFloat%Type%Matrix.Abs(getData(), getUnit());
        }
