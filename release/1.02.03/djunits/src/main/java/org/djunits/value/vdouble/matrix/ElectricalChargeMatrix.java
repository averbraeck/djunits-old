    ...
    TypedDoubleMatrixRel<ElectricalChargeUnit, ElectricalChargeMatrix, MutableElectricalChargeMatrix, ElectricalCharge>
{
     ...
     */
    public ElectricalChargeMatrix(final double[][] values, final ElectricalChargeUnit unit,
     ...
     */
    public ElectricalChargeMatrix(final ElectricalCharge[][] values, final StorageType storageType)
