...
/**
 * Immutable FloatAngleSlope Matrix.
 * <p>
 ...
 */
public interface FloatAngleSlopeMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedFloatMatrixAbs<AngleSlopeUnit, FloatAngleSlopeMatrix.Abs, FloatAngleSlopeMatrix.Rel, MutableFloatAngleSlopeMatrix.Abs, FloatAngleSlope.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable FloatAngleSlopeMatrix.
         * @param values float[][]; the values of the entries in the new Absolute Immutable FloatAngleSlopeMatrix
         * @param unit U; the unit of the new Absolute Immutable FloatAngleSlopeMatrix
         ...
         */
        public final FloatAngleSlopeMatrix.Rel toRel()
        {
            return new FloatAngleSlopeMatrix.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        TypedFloatMatrixRel<AngleSlopeUnit, FloatAngleSlopeMatrix.Rel, MutableFloatAngleSlopeMatrix.Rel, FloatAngleSlope.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable FloatAngleSlopeMatrix.
         * @param values float[][]; the values of the entries in the new Relative Immutable FloatAngleSlopeMatrix
         * @param unit U; the unit of the new Relative Immutable FloatAngleSlopeMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAngleSlopeMatrix.Abs toAbs()
        {
            return new FloatAngleSlopeMatrix.Abs(getData(), getUnit());
        }
