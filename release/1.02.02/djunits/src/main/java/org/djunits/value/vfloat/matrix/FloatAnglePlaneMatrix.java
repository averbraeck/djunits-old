...
/**
 * Immutable FloatAnglePlane Matrix.
 * <p>
 ...
 */
public interface FloatAnglePlaneMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedFloatMatrixAbs<AnglePlaneUnit, FloatAnglePlaneMatrix.Abs, FloatAnglePlaneMatrix.Rel, MutableFloatAnglePlaneMatrix.Abs, FloatAnglePlane.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable FloatAnglePlaneMatrix.
         * @param values float[][]; the values of the entries in the new Absolute Immutable FloatAnglePlaneMatrix
         * @param unit U; the unit of the new Absolute Immutable FloatAnglePlaneMatrix
         ...
         */
        public final FloatAnglePlaneMatrix.Rel toRel()
        {
            return new FloatAnglePlaneMatrix.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        TypedFloatMatrixRel<AnglePlaneUnit, FloatAnglePlaneMatrix.Rel, MutableFloatAnglePlaneMatrix.Rel, FloatAnglePlane.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable FloatAnglePlaneMatrix.
         * @param values float[][]; the values of the entries in the new Relative Immutable FloatAnglePlaneMatrix
         * @param unit U; the unit of the new Relative Immutable FloatAnglePlaneMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAnglePlaneMatrix.Abs toAbs()
        {
            return new FloatAnglePlaneMatrix.Abs(getData(), getUnit());
        }
