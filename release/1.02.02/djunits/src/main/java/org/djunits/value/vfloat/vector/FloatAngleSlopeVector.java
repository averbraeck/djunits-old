 ...
 */
public interface FloatAngleSlopeVector
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedFloatVectorAbs<AngleSlopeUnit, FloatAngleSlopeVector.Abs, FloatAngleSlopeVector.Rel, MutableFloatAngleSlopeVector.Abs, FloatAngleSlope.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable FloatAngleSlopeVector.
         * @param values float[]; the values of the entries in the new Absolute Immutable FloatAngleSlopeVector
         * @param unit U; the unit of the new Absolute Immutable FloatAngleSlopeVector
        ...
        /**
         * Construct a new Absolute Immutable FloatAngleSlopeVector.
         * @param values List; the values of the entries in the new Absolute Immutable FloatAngleSlopeVector
         * @param unit U; the unit of the new Absolute Immutable FloatAngleSlopeVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAngleSlopeVector.Rel toRel()
        {
            return new FloatAngleSlopeVector.Rel(getData(), getUnit());
        }
    ...
    class Rel
        extends
        TypedFloatVectorRel<AngleSlopeUnit, FloatAngleSlopeVector.Rel, MutableFloatAngleSlopeVector.Rel, FloatAngleSlope.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable FloatAngleSlopeVector.
         * @param values float[]; the values of the entries in the new Relative Immutable FloatAngleSlopeVector
         * @param unit U; the unit of the new Relative Immutable FloatAngleSlopeVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Immutable FloatAngleSlopeVector.
         * @param values List; the values of the entries in the new Relative Immutable FloatAngleSlopeVector
         * @param unit U; the unit of the new Relative Immutable FloatAngleSlopeVector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final FloatAngleSlopeVector.Abs toAbs()
        {
            return new FloatAngleSlopeVector.Abs(getData(), getUnit());
        }
