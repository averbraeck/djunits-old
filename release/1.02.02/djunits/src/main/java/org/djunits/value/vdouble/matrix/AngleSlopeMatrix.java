 ...
 */
public interface AngleSlopeMatrix
{
    /* ============================================================================================ */
    ...
    class Abs
        extends
        TypedDoubleMatrixAbs<AngleSlopeUnit, AngleSlopeMatrix.Abs, AngleSlopeMatrix.Rel, MutableAngleSlopeMatrix.Abs, AngleSlope.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Immutable Double AngleSlopeMatrix.
         * @param values double[][]; the values of the entries in the new Absolute Immutable Double AngleSlopeMatrix
         * @param unit U; the unit of the new Absolute Immutable Double AngleSlopeMatrix
         ...
         */
        public final AngleSlopeMatrix.Rel toRel()
        {
            return new AngleSlopeMatrix.Rel(getData(), getUnit());
        }
     ...
     */
    class Rel extends
        TypedDoubleMatrixRel<AngleSlopeUnit, AngleSlopeMatrix.Rel, MutableAngleSlopeMatrix.Rel, AngleSlope.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Immutable Double AngleSlopeMatrix.
         * @param values double[][]; the values of the entries in the new Relative Immutable Double AngleSlopeMatrix
         * @param unit U; the unit of the new Relative Immutable Double AngleSlopeMatrix
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
         ...
         */
        public final AngleSlopeMatrix.Abs toAbs()
        {
            return new AngleSlopeMatrix.Abs(getData(), getUnit());
        }
