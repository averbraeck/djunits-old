 ...
 */
public class AnglePlaneUnitTest extends AbstractLinearUnitTest<AnglePlaneUnit>
{
    /**
    ...
    {
        AnglePlaneUnit myAPU = new AnglePlaneUnit("point", "pt", OTHER, AnglePlaneUnit.RADIAN, 0.19634954085);
