...
public class DoubleScalarTest
{
    ...
    public final void basicsAbsTest()
    {
        ...
        DoubleScalar.Abs<TemperatureUnit> mds = new DoubleScalar.Abs<TemperatureUnit>(value, tempUnit);
        checkContentsAndType(mds, value, 0.001, tempUnit, true);
        mds = new DoubleScalar.Abs<TemperatureUnit>(-200, tempUnit);
        assertEquals("-200 Celsius roughly equivalent to 73 Kelvin", 73.0d, mds.si, 1.0d);
        mds = new DoubleScalar.Abs<TemperatureUnit>(temperatureDS);
        checkContentsAndType(mds, value, 0.001, tempUnit, true);
        ...
        {
            double v = i / 10.0;
            mds = new DoubleScalar.Abs<TemperatureUnit>(v, TemperatureUnit.SI);
    ...
    public final void equalsAbsTest()
    {
        ...
        DoubleScalar.Abs<LengthUnit> dsCompatibleUnit =
        ...
        DoubleScalar.Abs<LengthUnit> dsDifferentValue =
    ...
    public final void basicsRelTest()
    {
        ...
        mds = new DoubleScalar.Rel<TemperatureUnit>(-200, tempUnit);
        assertEquals("-200 Celsius roughly equivalent to 73 Kelvin", 73.0d, mds.si, 1.0d);
        mds = new DoubleScalar.Rel<TemperatureUnit>(temperatureDS);
        checkContentsAndType(mds, value, 0.001, tempUnit, false);
    ...
    public final void equalsRelTest()
    {
        ...
        assertEquals("The underlying SI values are the same", ds.getSI(), dsWrongBaseUnit.getSI(), 0.0001);
        assertFalse("Not equals because the standard SI unit differs", ds.equals(dsWrongBaseUnit));
        DoubleScalar.Rel<LengthUnit> dsCompatibleUnit =
            new DoubleScalar.Rel<LengthUnit>(38000.0, LengthUnit.MILLIMETER);
        assertFalse("Units are different", ds.getUnit().equals(dsCompatibleUnit.getUnit()));
        assertTrue("equals returns true", ds.equals(dsCompatibleUnit));
        DoubleScalar.Rel<LengthUnit> dsDifferentValue =
