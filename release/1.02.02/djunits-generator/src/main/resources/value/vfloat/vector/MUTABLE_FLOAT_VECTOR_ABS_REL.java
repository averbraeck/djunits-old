...
public interface MutableFloat%Type%Vector
{
    ...
    class Abs
        extends
        MutableTypedFloatVectorAbs<%Type%Unit, Float%Type%Vector.Abs, Float%Type%Vector.Rel, MutableFloat%Type%Vector.Abs, Float%Type%.Abs>
    {
        /** */
        private static final long serialVersionUID = 20151003L;

        /**
         * Construct a new Absolute Mutable Float%Type%Vector.
         * @param values float[]; the values of the entries in the new Absolute Mutable Float%Type%Vector
         * @param unit U; the unit of the new Absolute Mutable Float%Type%Vector
        ...
        /**
         * Construct a new Absolute Mutable Float%Type%Vector.
         * @param values List; the values of the entries in the new Absolute Mutable Float%Type%Vector
         * @param unit U; the unit of the new Absolute Mutable Float%Type%Vector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Absolute Mutable Float%Type%Vector.
         * @param values FloatScalar.Rel&lt;U&gt;[]; the values of the entries in the new Absolute Mutable Float%Type%Vector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         ...
         */
        public final MutableFloat%Type%Vector.Rel toRel()
        {
            return new MutableFloat%Type%Vector.Rel(getData(), getUnit());
        }
...
%FORMULAS%%Type%.Abs%
     ...
     */
    class Rel extends MutableTypedFloatVectorRel<%Type%Unit, Float%Type%Vector.Rel, MutableFloat%Type%Vector.Rel, Float%Type%.Rel>
    {
        /** */
        private static final long serialVersionUID = 20151006L;

        /**
         * Construct a new Relative Mutable Float%Type%Vector.
         * @param values float[]; the values of the entries in the new Relative Mutable Float%Type%Vector
         * @param unit U; the unit of the new Relative Mutable Float%Type%Vector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable Float%Type%Vector.
         * @param values List; the values of the entries in the new Relative Mutable Float%Type%Vector
         * @param unit U; the unit of the new Relative Mutable Float%Type%Vector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values is null
         */
        ...
        /**
         * Construct a new Relative Mutable Float%Type%Vector.
         * @param values FloatScalar.Rel&lt;U&gt;[]; the values of the entries in the new Relative Mutable Float%Type%Vector
         * @param storageType the data type to use (e.g., DENSE or SPARSE)
         * @throws ValueException when values has zero entries
         */
         ...
         */
        public final MutableFloat%Type%Vector.Abs toAbs()
        {
            return new MutableFloat%Type%Vector.Abs(getData(), getUnit());
        }
