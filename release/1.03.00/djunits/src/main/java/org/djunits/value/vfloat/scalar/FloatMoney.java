...
/**
 * Easy access methods for the Money FloatScalar, which is relative by definition. An example is Speed. Instead of <br>
 * <i>FloatScalar.Rel&lt;MoneyUnit&gt; value = new FloatScalar.Rel&lt;MoneyUnit&gt;(100.0, MoneyUnit.SI);</i><br>
 * we can now write <br>
 * <i>FloatMoney value = new FloatMoney(100.0, MoneyUnit.SI);</i><br>
