        ...
        TypedFloatVectorAbs<LengthUnit, FloatPositionVector, FloatLengthVector, MutableFloatPositionVector, FloatPosition>
{
     ...
     * @throws ValueException when values is null
     */
    public FloatPositionVector(final List<Float> values, final LengthUnit unit, final StorageType storageType)
            throws ValueException
    {
        super(values, unit, storageType);
    }
     ...
     * @throws ValueException when values is null
     */
    public FloatPositionVector(final SortedMap<Integer, Float> values, final LengthUnit unit, final int length,
     ...
     * @param unit the unit
     */
    FloatPositionVector(final FloatVectorData data, final LengthUnit unit)
    {
        super(data, unit);
    }
    ...
    {
        return new FloatLengthVector(getData(), getUnit());
    }
